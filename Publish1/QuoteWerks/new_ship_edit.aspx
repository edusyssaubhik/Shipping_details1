...
<tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="leftNavigation" >
      <!--#include virtual="/QuoteWerks/leftmenu.aspx"-->
    </table></td>
            ...
            <tr>
                ...
                <asp:Label ID="Label1" runat="server" Text=" Company Name"></asp:Label>
                           ...
                           <td class="auto-style28">
                               ...
                               <asp:DropDownList ID="DropDownList18" runat="server"  OnSelectedIndexChanged="DropDownList18_SelectedIndexChanged" Width="172px" AutoPostBack="True">
                               </asp:DropDownList>
                ...
                <asp:Label ID="Label12" runat="server" Text="Enter Company details:" Visible="False"></asp:Label>
                       ...
                       <tr>
                           <td class="auto-style8">
                <asp:Label ID="Label4" runat="server" Text="Enter Name" Visible="False"></asp:Label>
                           </td>
                       <td>
                       ...
                       <tr>
                           <td class="auto-style8">
                <asp:Label ID="Label5" runat="server" Text="Enter  email ID" Visible="False"></asp:Label>
                           </td>
                       <td>
                           <asp:DropDownList ID="DropDownList21" runat="server" AutoPostBack="True" Width="177px" Visible="False">
                           </asp:DropDownList>
                           <br />
                           </td>
                       </tr>
                       <tr>
                           <td class="auto-style8">
                <asp:Label ID="Label6" runat="server" Text="Enter phone no" Visible="False"></asp:Label>
                           </td>
                       <td>
                           <asp:DropDownList ID="DropDownList22" runat="server" OnSelectedIndexChanged="DropDownList22_SelectedIndexChanged" AutoPostBack="True"  Width="176px" Visible="False">
                           </asp:DropDownList>
                           <br />
                           </td>
                       </tr>
                ...
                <asp:Label ID="Label7" runat="server" Text="Enter Fax No" Visible="False"></asp:Label>
                       ...
                       <td>
                           <asp:DropDownList ID="DropDownList23" runat="server" OnSelectedIndexChanged="DropDownList23_SelectedIndexChanged" AutoPostBack="True"  Width="177px" Visible="False">
                           </asp:DropDownList>
                           <br />
                           </td>
                       </tr>
                ...
                <asp:Label ID="Label10" runat="server" Text="Ship To"></asp:Label>
                        ...
                        <tr>
                            ...
                            <td class="auto-style25">
                                <asp:CheckBox ID="CheckBox1" runat="server" AutoPostBack="True" Enabled="False" OnCheckedChanged="CheckBox1_CheckedChanged1" Text="Same as old address" />
                            </td>
                       ...
                       <td class="auto-style36">
                        ...
                        <tr>
                            ...
                            <td class="auto-style13">
                                ...
                                <br />
                                <br />
                                <asp:Button ID="Button4" runat="server"  OnClick="Button4_Click1" Text="Submit" Width="123px" />
                            </td>
                ...
                <asp:Label ID="Label19" runat="server" Text="Bill To"></asp:Label>
                        ...
                        <tr>
                            <td class="auto-style20">
                                ...
                                &nbsp;</td>
                            <td >
                                <asp:CheckBox ID="CheckBox3" runat="server" AutoPostBack="True" Enabled="False" OnCheckedChanged="CheckBox3_CheckedChanged" Text="Same as sold Address" />
                            </td>
                        </tr>
                        <tr>
                            <td >
                ...
                <asp:Label ID="Label24" runat="server" Text="Enter phone no" Visible="False"></asp:Label>
                       ...
                       <td class="auto-style21">
                           <asp:DropDownList ID="DropDownList32" runat="server" OnSelectedIndexChanged="DropDownList32_SelectedIndexChanged" AutoPostBack="True" Height="17px" Visible="False" Width="130px">
                           </asp:DropDownList>
                           </td>
                        </tr>
                        <tr>
