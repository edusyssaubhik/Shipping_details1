...
<td width="25%" class="general-body">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" >
    ...
    <tr>
     ...
     <tr>
      <td class="LeftLinks"><a href="/Quotewerks/selectcountry.asp">Create Quote &nbsp;&nbsp;&nbsp;</a></td>
    </tr>
     <tr>
      <td class="LeftLinks"><a href="/Quotewerks/ViewEditQuote.asp">View/Edit Quote &nbsp;&nbsp;&nbsp;</a></td>
    </tr> 
     <tr>
    ...
    <% End If %>
    <tr>
      <td class="LeftLinks"><a href="/Quotewerks/country.asp">Add Country &nbsp;&nbsp;&nbsp;</a></td>
    </tr> 
    <tr>
