...
if(window.XMLHttpRequest){
 ...
 //
       req1.onreadystatechange=onReadyState1;
       req1.open("GET","/QuoteWerks/edit_update_items12.asp?query="+new_code+"&total="+q1+"&tax="+q2+"&act="+q3+"&sell="+q4+"&dis="+q5+"&margin="+q6,true);
    req1.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
    req1.send(null);
          }
...
if(window.XMLHttpRequest){
 ...
 //
    ...
    req2.open("GET","/QuoteWerks/edit_update_items21.asp?query="+item+"&total="+q1+"&tax="+q2+"&act="+q3+"&sell="+q4+"&dis="+q5+"&margin="+q6,true);
...
SQL="SELECT itemName a ,itemCode b,cost c,price d,quantity e,actualPrice f,discount g ,discountAmount h,sellingPrice i,FinalPrice j,tax k,shipping l,courseid id,margin m FROM QW_QuoteDetails where quoteId='"&ses_new&"' and itemCode  in ("& common_item &")"
rs.open SQL, ConnObj
While Not rs.EOF
i=i+1 
j=j+1
