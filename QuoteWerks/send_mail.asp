...
<script src="/Quotewerks/js/callPDF.js"></script>
...
strBody = strBody &"<div style=""width: 866px; height: 160px; float: left; font-family: Arial, Helvetica, sans-serif; font-size: 10px; margin-left: 16px;""><div style=""width: 484px; float: left; text-align:left;visibility:hidden""><table width=""192"" border=""0"" cellspacing=""0"" cellpadding=""0"" style=""visibility:hidden""><tr><td width=""36"" height=""22""></td><td height=""22""></td></tr><tr><td width=""36"" height=""22""></td><td height=""22"" ></td></tr><tr><td width=""36"" height=""22""></td><td height=""22"" ></td></tr><tr><td width=""36"" height=""22""></td><td height=""22"" ></td></tr></table></div><div style=""width: 187px; float: left;""><div ><b>Please note: discounts are appliedassuming prompt payment and will beremoved from overdue invoices.</b></div></div><div style=""width: 162px; float: right;""><div style=""width: 155px; height: 68px; padding: 4px; border: 1px solid #ccc;"">"
end if
...
'myMail.Cc = "edusyssaubhik@gmail.com,edusyssidhardha@gmail.com,edusyssavita@gmail.com,edusysayan@gmail.com"
 myMail.Cc = "operations@datrixtraining.com"
         if action = "View_IS" then
myMail.Subject = "Please find the below invoice."
...
myMail.AddAttachment server.MapPath("/Quotewerks/Cerpdf/"&rqquoteid&"_"&action&".pdf")
myMail.Send
set myMail=nothing
