...
strEmpDet = "SELECT * FROM users ORDER BY firstname"
Else
strEmpDet = "SELECT * FROM users where userid = '"& Session("QWUserName")&"' ORDER BY firstname"
End If
...
function validate_form1(thisform)
{
		...
		with (thisform)
		{
		  //Check To See If The UserId Field Is Balnk    
				...
				if (validate_required(typeofuser,"Please select Access granted")==false)
        ...
        <form  action="/QuoteWerks/addeditUser.asp"  method="post" onSubmit="return validate_form1(this)">
          <table width="100%" border="0" cellspacing="0" cellpadding="8px">
           ...
           <!--  <tr>
            ...
            <tr>
              <td width="30%" height="25"><label>Country<span class="small">Add country</span></label></td>
              <td height="25"><select name="country" id="country">
                  <option value="">--Select--</option>
...
strEmpDetail = "SELECT * FROM Users WHERE id= '"& rqId&"'"
        ...
        <form  action="addeditUser.asp"  method="post" onSubmit="return validate_form1(this)">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="8px">
            ...
            <tr>
              ...
              <td height="25"><select name="country" id="country">
                  <option value="">--Select--</option>
                  <option value="1" <% If objRs1("country") = "1" Then %> selected="selected" <% End If %>>United Kingdom</option>
                  <option value="2" <% If objRs1("country") = "2" Then %> selected="selected" <% End If %>>US</option>
                  <option value="3" <% If objRs1("country") = "3" Then %> selected="selected" <% End If %>> India</option>
                  <option value="4" <% If objRs1("country") = "4" Then %> selected="selected" <% End If %>>Canada</option>
    ...
    <div style="width:100%">
        ...
        <% If IsArray(arrAllUsers) Then %>
          ...
          <% 
			...
			' response.Write( arrAllUsers(10,rowcounter))
		  %>
          <tbody>
            <tr>
              ...
              <td width="15%" ><% = arrAllUsers(13,rowcounter) %></td>
