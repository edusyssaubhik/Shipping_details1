...
{
    window.location = "Update_oppurtunity.aspx?qid="+x+"&query=V2";
}
...
<tr><br></tr>
 <tr>
     ...
     <!-- <td width = "45%"><button type="submit" name="type" value="Back" onClick="load_backup()">Back</button></td>-->
      ...
      <td width = "45%"><button type="submit" name="type" value="Submit" onClick="abc()">Save</button></td>
       <td width = "45%"><button type="submit" name="type" value="Submit" onClick="abc1(<%=Session("new_quoteid") %>)">Sent
