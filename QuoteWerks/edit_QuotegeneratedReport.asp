...
'<td valign=""middle"" valign=""top"" width=""53"" align=""center"" style=""border: 1px solid #bfbfbf;""><b>Date</b></td><td valign=""middle"" valign=""top"" width=""63"" align=""center"" style=""border: 1px solid #bfbfbf;""><b>Location</b></td>
			 ...
			 Dim item_id,sql1
		   item_id=""
	      dim  SrNo,id,code,userimage,usersign
		   SrNo=1
...
<% =Session("SoldAddress")  %><br />Email:<%=Session("email1")%>  
<br />    Phone:  <%=Session("ph1")%> </td>
  
   
 <td valign="top">
<% =Session("ship_name1") %><br />
<% =Session("ShipAddress")  %><br />Email:<%=Session("email2")%>   <br />   Phone:<%=Session("ph2")%>  </td>
...
myMail.AddAttachment server.MapPath("/Quotewerks/Cerpdf/"&x1&"_View.pdf")
