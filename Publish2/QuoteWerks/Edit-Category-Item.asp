...
<td width="69"><select name="select2" size="10" multiple id="d">
 ...
 %>
<option value="<%=objRs2("a")%>"><%=objRs2("b")%></option>
<%
objRs2.MoveNext
wend
objRs2.Close
...
<center> <div id="styledForm1" class="myform"> <button type="submit"  name="type1" value="Add1"  onClick="select_element('V2')" >Next</button></div></center>
