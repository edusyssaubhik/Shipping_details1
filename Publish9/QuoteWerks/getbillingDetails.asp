...
'if rqAddCompany <> "" then
 ...
 str = "<form action=""changeshippingAddress.asp"" method=""post"" ><table id=""hello3""><tr><td>Enter company name:</td>"
...
Rs.open strCompany,ConnObj
 ...
 str = str&"<td><input type=""text"" name=""billcompanyname"" id=""billcompanyname"" value="&Rs("CompName")&"/></td></tr><tr><td>Enter Address:</td><td><Select name=""billselectcompanyaddress_1"" id=""billselectcompanyaddress_1"" ><option value=""Select"">--Select--</option>"
...
str = str&"</select></td></tr><tr><td>Enter email-id:</td><td><Select name=""billcontactemail_1"" id=""billcontactemail_1""><option value=""Select"">--Select--</option>"
...
str = str&"</Select></td></tr><tr><td>Enter phone:</td><td><Select name=""billselectcontactphone_1"" id=""billselectcontactphone_1""><option value=""Select"">--Select--</option>"
...
str = str&"</Select></td></tr><tr><td>Enter faxno:</td><td><Select name=""billselectfax_1"" id=""billselectfax_1""><option value=""Select"">--Select--</option>"
