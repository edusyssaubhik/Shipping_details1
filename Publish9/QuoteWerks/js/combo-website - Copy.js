 //globals
 var first = "website"; //id of first SELECT
 var second = "country"; //id of second SELECT
...
document.write(data);
 ...
 //document.write(el.options[selected].value);
//
 ...
 if(selected!= 0) { //if they choose something other than the first select-->"Select topic first"
    sendRequest('getCountries.asp?websiteId='+el.options[selected].value);
    ob2.disabled=0;
