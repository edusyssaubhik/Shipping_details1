...
strEmpDet= "UPDATE QW_QuoteOverview  SET "
		  ...
		  strEmpDet= strEmpDet& "status = 'Payment Received'"
...
strEmpDet1= "UPDATE QW_QuoteDetails  SET "
		  ...
		  strEmpDet1= strEmpDet1& "status = 'Payment Received'"
...
strBody = "<table width=""600px"" border=""0""><tr height=""30px""><td><font face=""Arial"" size=2>Dear "&Session("sold_name1")&",<BR><BR>Greetings from Datrix Training! <BR><BR>We acknowledge with thanks receipt of "&rqtotalAmount&" through <Payment mode> dated <Payment date> towards Invoice number <Invoice number>. Please see below the payment receipt for the services delivered by Datrix Training to <Company Name>"
...
'objCDOMail.Subject = "Payment Receipt from Datrix Training"
...
<div id="quote-wrapper">
  <div id="quote-header">
     <table width="100%" border="0" cellspacing="0" cellpadding="0" height="65px">
         <tr>
           <td width="210px" valign="top"><img src="/QuoteWerks/images/payment-receipt.jpg" /></td>
...
<br />
  ...
  <div style="width:auto;height:10000px; overflow:visible;" id="pdfRenderer">
   ...
   <td>
    <input type="text" name="ponumber" />(optional)
</td>
    </tr>
    <tr><td><button type="Sumbit" name="Type"  value="Sumbit">Accept P.O Order</button></td></tr>
 </table>
