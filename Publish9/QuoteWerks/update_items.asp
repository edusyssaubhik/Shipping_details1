...
'Session("quote")=""
  ...
  sql1="update QW_QuoteOverview set countryId='"&Session("country")&"',totalAmount='"& total &"',tax='"& tax &"' ,totalDiscount ='"& dis &"' ,totalActualPrice='"& act &"',totalsellingPrice='"& sell &"',margin_total='"& margin_total &"' where quoteId='"&Session("quote")&"'"
