...
strQuote = "SELECT quoteId, sentDate, userId, totalAmount, tax, companyId, status,PONumber,quoteno,createdDate FROM QW_QuoteOverview WHERE status = 'In Process' order by sentDate desc"


Else

strQuote = "SELECT quoteId, sentDate, userId, totalAmount, tax, companyId, status,PONumber,quoteno,createdDate FROM QW_QuoteOverview WHERE status = '"& rqAction &"' order by sentDate desc"
