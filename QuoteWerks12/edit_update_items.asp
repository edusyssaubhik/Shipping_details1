...
'Session("quote_no")
 ...
 strQuery = "INSERT INTO QW_QuoteDetails(quoteId,versionNo,itemName,itemCode,cost,price,quantity,actualPrice,discount,discountAmount,sellingPrice,FinalPrice,tax,shipping,totalAmount,addedBy,addedDate,status,quoteno) values  ('"& Session("new_quoteid")&"',"&version_no&","&items&",'"&Session("QWUserName")&"','"& Now() &"','In Process','"&qono&"')"
