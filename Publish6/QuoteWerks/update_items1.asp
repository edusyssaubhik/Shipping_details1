...
dis=request.QueryString("dis")
 ...
 'new_code=Split(req,";")
 strQuery = "INSERT INTO QW_QuoteDetails(quoteId,versionNo,itemName,itemCode,cost,price,quantity,actualPrice,discount,discountAmount,sellingPrice,FinalPrice,tax,shipping,totalAmount,courseid,addedBy,addedDate,status,quoteno) values  ('"&Session("quote")&"',1,"&req&",'"&Session("QWUserName")&"','"& Now() &"','In Process','"&Session("quote_no")&"')"
