        ...
        &nbsp;<table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;width:100%; height: 795px;">
            <tr>
                ...
                <asp:Label ID="Label5" runat="server" Text="Enter  email ID" Visible="False"></asp:Label>
                       ...
                       <td>
                           <asp:DropDownList ID="DropDownList21" runat="server" Width="177px" Visible="False" OnSelectedIndexChanged="DropDownList21_SelectedIndexChanged">
                           </asp:DropDownList>
                           <br />
                           </td>
                       </tr>
                ...
                <asp:Label ID="Label6" runat="server" Text="Enter phone no" Visible="False"></asp:Label>
                       ...
                       <td>
                           <asp:DropDownList ID="DropDownList22" runat="server" OnSelectedIndexChanged="DropDownList22_SelectedIndexChanged"  Width="176px" Visible="False">
                           </asp:DropDownList>
                           <br />
                           </td>
                       </tr>
