        ...
        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="950px">
		 ...
		 %>
          <tr>
           ...
           <td> <a href="/Quotewerks/ViewEditQuote.asp?action=View&id=<% = quoteId %>" target="_blank">View P.O</a></td>
            <% End If %>
            
             <% If quoteStatus = "Invoice Sent" Then %>
            <td><a href="/Quotewerks/ViewEditQuote.asp?action=View&id=<% = quoteId %>" target="_blank">View Invoice</a></td>
            <% End If %>
