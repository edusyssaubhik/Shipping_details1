...
{
	window.open("/QuoteWerks/SendInvoiceReport.asp")
}
</script>
<%
...
strEmpDet= "UPDATE QW_QuoteOverview  SET "
		  ...
		  strEmpDet= strEmpDet& "status = 'Invoice Sent'"
...
strEmpDet1= "UPDATE QW_QuoteDetails  SET "
		  ...
		  strEmpDet1= strEmpDet1& "status = 'Invoice Sent'"
...
strBody = "<table width=""600px"" border=""0""><tr height=""30px""><td><font face=""Arial"" size=2>Dear "&Session("sold_name1")&",<BR><BR>Greetings from Datrix Training! <BR><BR>Thank you for choosing Datrix for your training needs and we hope the delegates from your esteemed company had a good experience with us.<br>Please see below the invoice for the services delivered by Datrix Training to "&Session("sold_cname")&" <BR><BR></td></tr></table><table width=""600px"" border=""0"" style=""border:1px solid #ccc;"" cellspacing=""0"" cellpadding=""0"" ><tr><td align=""center"" valign=""top""><div style=""width: 898px; height: 600px; background-color: #fff; margin: 6px auto 0px;""><div style=""width: 898px; height: 600px; float: left;""><div style=""width: 860px; height: 65px; float: left; font-family: Arial, Helvetica, sans-serif; font-size: 11px; margin-left: 19px; margin-top: 26px;""><table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0"" height=""65px""><tr><td width=""210px"" valign=""top""><img src=""http://projstudy.com/QuoteWerks/images/logo.jpg"" /></td><td width=""420px"" valign=""top"">N1 Chorley Business &amp; Technology Centre Euxton Lane, Chorley PR7 6TE Phone: 0800 7810626 Fax: 01257270478</td><td valign=""top""><img src=""http://projstudy.com/QuoteWerks/images/invoice.jpg"" align=""right"" /><table width=""100%"" border=""0"" cellspacing=""0"" cellpadding=""0""><tr><td style=""text-align: right; padding-top: 6px;"" align=""right""><b>Number</b></td><td style=""text-align: right; padding-top: 6px;"" align=""right""><b>"
...
'objCDOMail.Subject = "Invoice from Datrix Training, Invoice number <Invoice number>"
...
<div id="quote-wrapper">
  <div id="quote-header">
     <table width="100%" border="0" cellspacing="0" cellpadding="0" height="65px">
         <tr>
           <td width="210px" valign="top"><img src="/QuoteWerks/images/invoice.jpg" /></td>
...
<br />
  ...
  <div style="width:auto;height:10000px; overflow:visible;" id="pdfRenderer">
     ...
     <tr><td><button type="submit" name="type" value="SendInvoice" onClick="SendInvoice()">Send</button></td></tr>
 </table>
