...
//Check To See If The Course End Date Field Is Blank
  ...
  {
      var j,m;
      var x="checkOut_date"+i;
      var y="checkIn_date"+i;

      //j=theform.startdate+"".value;
      j=document.getElementById(x).value;
...
<div id="htMap">
  ...
  <% elseIf session("certificate") <> ""  Then %>
    <tr id="htMap">
      <td  height="25px" >  <% If Session("typeofuser") <> "CSR" Then %><a href="courses.asp?type=add&certificate=<% = rqCertificate %>">Add <% = session("certificate") %> Course </a> |  <% End If %> <a href="courses.asp?Course=PastCourses&certificate=<% = rqCertificate %>">Past Courses</a> | <a href="courses.asp?Course=FutureCourses&certificate=<% = rqCertificate %>">Future Courses</a> | <a href="courses.asp?type=selectcourse"><span style="color:#FF3300">Change certification type</span></a></td>
    </tr>
    ...
    <tr>
      <td align="left" height="200px"><form name="addcourse" action="addEditDeleteCourse.asp" method="post" onsubmit="return Form_Validator(this)">
        ...
        <table border="0" cellpadding="5" align="left" cellspacing="6" style="width: 99%">
      <tr>
    ...
    <tr>
        ...
        <td>Ref Number:</td>
          <td>&nbsp;&nbsp;
           <input type="text" name="RefNumber" id="RefNumber" size="20" />
          </td>
        </tr>
        ...
        <td>Duration:</td>
          <td>&nbsp;&nbsp;
           <input type="text" name="duration" id="duration" size="20" /> (eg: 3 Days)
          </td>
        </tr>
        <% End IF %>
        ...
        <tr>
          ...
          <td class="auto-style1"><input autocomplete="off" name="enddate" readonly id="checkOut_date" type="text">
        ...
        <tr>
          <td class="zpCalSubheader"> Date Begin: </td>
          <td><input autocomplete="off" name="startdate1" readonly id="checkIn_date1" type="text">
            <input value=" ... " id="button8c" class="buttonc" type="reset">
          </td>
          <td class="zpCalSubheader"> Date End: </td>
          <td class="auto-style1"><input autocomplete="off" name="enddate1" readonly id="checkOut_date1" type="text">
        ...
        <tr>
          <td class="zpCalSubheader"> Date Begin: </td>
          <td><input autocomplete="off" name="startdate2" readonly id="checkIn_date2" type="text">
            <input value=" ... " id="button8e" class="buttonc" type="reset">
          </td>
          <td class="zpCalSubheader"> Date End: </td>
          <td class="auto-style1"><input autocomplete="off" name="enddate2" readonly id="checkOut_date2" type="text">
        ...
        <tr>
          <td class="zpCalSubheader"> Date Begin: </td>
          <td><input autocomplete="off" name="startdate3" readonly id="checkIn_date3" type="text">
            <input value=" ... " id="button8g" class="buttonc" type="reset">
          </td>
          <td class="zpCalSubheader"> Date End: </td>
          <td class="auto-style1"><input autocomplete="off" name="enddate3" readonly id="checkOut_date3" type="text">
        ...
        <tr>
          <td class="zpCalSubheader"> Date Begin: </td>
          <td><input autocomplete="off" name="startdate4" readonly id="checkIn_date4" type="text">
            <input value=" ... " id="button8i" class="buttonc" type="reset">
          </td>
          <td class="zpCalSubheader"> Date End: </td>
          <td class="auto-style1"><input autocomplete="off" name="enddate4" readonly id="checkOut_date4" type="text">
        ...
        <tr>
          <td class="zpCalSubheader"> Date Begin: </td>
          <td><input autocomplete="off" name="startdate5" readonly id="checkIn_date5" type="text">
            <input value=" ... " id="button8k" class="buttonc" type="reset">
          </td>
          <td class="zpCalSubheader"> Date End: </td>
          <td class="auto-style1"><input autocomplete="off" name="enddate5" readonly id="checkOut_date5" type="text">
            <input value=" ... " id="button8l" class="buttonc" type="reset">
          </td>

        </tr>
        <tr>
          <td class="zpCalSubheader"> Date Begin: </td>
          <td><input autocomplete="off" name="startdate6" readonly id="checkIn_date6" type="text">
            <input value=" ... " id="button8m" class="buttonc" type="reset">
          </td>
          <td class="zpCalSubheader"> Date End: </td>
          <td class="auto-style1"><input autocomplete="off" name="enddate6" readonly id="checkOut_date6" type="text">
            <input value=" ... " id="button8n" class="buttonc" type="reset">
          </td>

        </tr>
        <tr>
          <td class="zpCalSubheader"> Date Begin: </td>
          <td><input autocomplete="off" name="startdate7" readonly id="checkIn_date7" type="text">
            <input value=" ... " id="button8o" class="buttonc" type="reset">
          </td>
          <td class="zpCalSubheader"> Date End: </td>
          <td class="auto-style1"><input autocomplete="off" name="enddate7" readonly id="checkOut_date7" type="text">
            <input value=" ... " id="button8p" class="buttonc" type="reset">
          </td>

        </tr>
        <tr>
          <td class="zpCalSubheader"> Date Begin: </td>
          <td><input autocomplete="off" name="startdate8" readonly id="checkIn_date8" type="text">
            <input value=" ... " id="button8q" class="buttonc" type="reset">
          </td>
          <td class="zpCalSubheader"> Date End: </td>
          <td class="auto-style1"><input autocomplete="off" name="enddate8" readonly id="checkOut_date8" type="text">
            <input value=" ... " id="button8r" class="buttonc" type="reset">
          </td>

        </tr>
        <tr>
          <td class="zpCalSubheader"> Date Begin: </td>
          <td><input autocomplete="off" name="startdate9" readonly id="checkIn_date9" type="text">
            <input value=" ... " id="button8s" class="buttonc" type="reset">
          </td>
          <td class="zpCalSubheader"> Date End: </td>
          <td class="auto-style1"><input autocomplete="off" name="enddate9" readonly id="checkOut_date9" type="text">
            <input value=" ... " id="button8t" class="buttonc" type="reset">
          </td>
       ...
       <% If Session("country") = "US" OR Session("country") = "Canada" OR Session("country") = "United Kingdom"  Then %>
        ...
        <tr>
          ...
          <td >Tax:</td>
          <td class="auto-style1"><input type="text" name="tax" size="20" maxlength="6" onchange="calculate();" value="0">
            <br>
        ...
        <tr>
          ...
          <td class="auto-style1"><input type="text" name="applicabledays" maxlength="10" size="20">
            <br>
        ...
        <tr>
          ...
          <td class="auto-style1"><input type="text" name="afterearlybirddiscountwithtax" readonly="true"></td>
        </tr>
        <tr>
          <td  width="250px">Hotel Name: </td>
          <td><input type="text" maxlength="200" name="hotelname"></td>
          <td  width="310px">Hotel Phone Number: </td>
          <td class="auto-style1"><input type="text" maxlength="50" name="hotelphonenumber">
            <br />
          ...
          <tr>
              <td colspan="4" align="center"><input type="submit" name="addcourse" value="Add Course" class="buttonc"  onclick="Form_Validator(this),checkUrl(this.hotelurl)">
              </td>
            </tr>
        </form>
    <tr>
...
<div align="center"><input type ="submit" name="type" class="buttonc" value="Save"/></div></span></span><br /><br />
 ...
 <% If  ISNULL(arrAllQueries(51,enrollrowcounter)) OR arrAllQueries(51,enrollrowcounter) = ""  then%>
   ...
   <!-- <a href="javascript:void(0)" onClick="window.open('generateReport.asp?CourseId=<% = courseId %>')">Generate Report</a>-->
