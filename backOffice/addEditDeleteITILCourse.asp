...
If addCourse = "Add Course" Then
 ...
 strQuery = "INSERT INTO PROJITIL_course (city,startdate,enddate,starthour,startminute,startsession,endhour,endminute,endsession,pricewithouttax,tax,pricewithtax,instructor,backupinstructor,applicabledays,earlybirddiscount,afterEBdiscountwithouttax,afterEBdiscountwithtax,hotelname,hotelphonenumber,hotelurl,hoteladdress,createddate,country,coursedates,coursetype,certificateId,vendorId,status)"
...
If editCourse = "Edit Course" Then
 ...
 strQuery = "UPDATE PROJITIL_course SET"
...
If rqDeleteId <> "" Then
 ...
 strQuery = "DELETE FROM PROJITIL_course WHERE courseid = '" & rqDeleteId & "' "
