...
'Retrive All terms Defintion Values From terms_Defintion.asp Page'
 ...
 rqRefPage           =  Request.Form("refpage")
...
If rqType = "Add" Then
 ...
 strQuery = "INSERT INTO term_definition (term,definition,reference_page,addedby,addedon)"
 strQuery = strQuery & " Values "
 strQuery = strQuery & "('" & rqTerm & "',"
 strQuery = strQuery & "'" & rqDefinition & "',"
 strQuery = strQuery & "'" & rqRefPage & "',"
 ...
 Response.Redirect("/backOffice/terms_definition.asp")
...
If rqType = "Update" Then
 ...
 strQuery = "UPDATE term_definition SET"
 strQuery = strQuery & " term = '" & rqEditTerm & "',"
 strQuery = strQuery & " definition = '" & rqEditDefinition & "',"
 strQuery = strQuery & " reference_page = '" & rqEditRefPage & "',"
...
Else
 ...
 strQuery1 = "DELETE  FROM term_definition WHERE id = '" & rqDelete & "'"
