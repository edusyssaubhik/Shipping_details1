...
objRs.Open strQuery, ConnObj
			...
			body = "<table width=""100%"" bordrer=""1"" bgcolor=""#CCCCCC"" style=""margin:0px;0px;0px;0px;""><tr><td height=""45px"">&nbsp;</td></tr><tr><td><table width=""45%"" border=""0"" align=""center"" cellpadding=""2"" cellspacing=""12"" bgcolor=""#FFFFFF""><tr><td align=""center"" width=""600px"" bgcolor=""#FFFFFF"">"
			
			IF Session("country") = "India" Then
						body= body & "<span><img src=""http://www.PROJstudy.com/images/banners/email_headerIN.jpg"" alt=""PROJstudy"" width=""600px"" height=""103"" /></span>" 
						ElseIf Session("country")="United Kingdom" Then 
						body= body &"<span><img src=""http://www.PROJstudy.com/images/banners/email_headerUK.jpg"" alt=""PROJstudy"" width=""600px"" height=""103"" /></span>"
						ElseIf Session("country")="Australia" Then
						body= body &"<span><img src=""http://www.PROJstudy.com/images/banners/email_headerAUS.jpg"" alt=""PROJstudy"" width=""600px"" height=""103"" /></span>"
						Else
						body= body &"<span><img src=""http://www.PROJstudy.com/images/banners/email_header.jpg"" alt=""PROJstudy"" width=""600px"" height=""103"" /></span>"
						End if
						body= body &"</td></tr>"
			
			body= body &"<hr></td></tr><tr><td colspan=""2"" width=""580px""><table border=""0"" cellpadding=""10"" width=""480px""><tr><td valign=""top"">"
			

			body= body & "Hi, <BR><BR>Please find below the payment decline report from date <B>"&rqfromDate&"</B> to <B>"&rqtoDate&"</B> :<br><br><table width=""600px"" border=""1""   cellspacing=""0""><tr><td width =""20px"">Sr No.</td><td width =""50px"">Website</td><td width =""100px"" >Payment Detail</td><td width =""200px"">Customer Details</td><td width =""50px"">Payment Decline Date</td><td width =""50px"">Course</td><td width =""50px"">Country</td><td width =""50px"">Amount [USD]</td><td width =""50px"">Order Status</td><td width =""500px""> Action </td><td width =""150px"">Failure reason</td></tr>"
...
objCDOMail.Bcc = "projstudysales@gmail.com"
