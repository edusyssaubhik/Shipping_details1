...
strQuery ="SELECT Courseid,mailSent from feedbackMail where Courseid ='"&Courseid1&"'"

 Rs2.Open strQuery,ConnObj
If Not Rs2.EOF Then
...
If Courseid = "" Then
  ...
  body = body & "</td></tr><tr><td><table align=""center"" border=""0"" width=""580px"">"
  ...
  body = body & "<br><font face=""Arial"" size=2><a href=""http://www.PROJstudy.com/"">www.PROJstudy.com</a>"
  

  
  body = body & "<br><font face=""Arial"" size=2>Email: <a href=""mailto:marketing@PROJstudy.com""/>marketing@PROJstudy.com</a></td></tr></table></td></tr><tr height=""30px""><td>&nbsp;</td></tr></table></td></tr><tr height=""45px""><td>&nbsp;</td></tr></table>"
...
strQuery1 = "Insert INTO feedbackMail(MailSent,courseid ) values ('1', '"&Courseid1&"')"
