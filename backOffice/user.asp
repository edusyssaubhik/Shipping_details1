...
rqEdit = Request.Querystring("editUserId")
 ...
 strQuery1  = "SELECT * FROM users WHERE id = '" & rqEdit & "'"
...
<table border="1" width="1000" height="500" cellpadding="2" cellspacing="0" class="dbborder" >
 ...
 <tr>
   ...
   <tr>
	  <td>
	   <form action="addEditDeleteUser.asp" method="post" onSubmit="return validate_form(this)">
	   <table border="0" align="center" cellpadding="5" cellspacing="5" class="dbborder" >
	    ...
	    <tr>
	      ...
	      <td width="60%"><input type="text" name="firstname" size="30">	    </tr>
	    <tr>
	      <td>LastName:</td>
	      <td><input type="text" name="lastname" size="30">	    </tr>
	    <tr>
	      <td>User Name:</td>
	    ...
	    <tr>
	     ...
	     <tr>
	      <td>Phone Number1:</td>
	      <td><input type="text" name="phoneno1" size="30"></td>
	     </tr>
	     <tr>
	      <td>Phone Number2:</td>
	      <td><input type="text" name="phoneno2" size="30"></td>
	     </tr>
	     <tr>
	      <td>EmailID Official:</td>
	      <td><input type="text" name="officialemailid" size="30"></td>
	     </tr>
	     <tr>
	      <td>EmailID Personal:</td>
	      <td><input type="text" name="personalemailid" size="30"></td>
	     </tr>
	     <tr>
	      <td>Type Of User:</td>
	      <td>&nbsp;
	     ...
	     <tr>
	       ...
	       <input type="submit" name="type" class="buttonc" value="Create User">	       </td>
	     </tr>
	    </table>
	    </form>
	   </td>
  ...
  <% If rqType = "Edit"  Then %>
      <tr>
         <td>
	       <form action="addEditDeleteUser.asp" method="post" onSubmit="return validate_form1(this)">
	       <table border="0" align="center" cellpadding="5" cellspacing="5" class="dbborder">
	        <tr>
	         <td colspan="2" align="center" bgcolor="#A7DBFB"><font size="3"><b>Edit User</b></font></td>
	        </tr>
	        <% do until Rs1.EOF %>
	        <input type="hidden" name="userId" value="<% = Rs1("id") %>">
	        <tr>
	         <td width="30%">FirstName:</td>
	         <td width="60%"><input type="text" name="editfirstname" size="30" value="<% = Rs1("firstname") %>">
	        </tr>
	  	  <tr>
	  	   <td>LastName:</td>
	  	   <td><input type="text" name="editlastname" size="30" value="<% = Rs1("lastname") %>">
	        </tr>
	        <tr>
	  	    <td>Password:</td>
	        ...
	        <tr>
	  	    <td>ConfirmPassword:</td>
	  	    <td><input type="password" name="editconfirmpassword" size="30" value="<% = Rs1("confirmpassword") %>"></td>
	        </tr>
		    <tr>
			  <td>Phone Number1:</td>
			  <td><input type="text" name="editphoneno1" size="30" value="<% = Rs1("phoneno1") %>"></td>
			 </tr>
			 <tr>
			  <td>Phone Number2:</td>
			  <td><input type="text" name="editphoneno2" size="30" value="<% = Rs1("phoneno2") %>"></td>
			 </tr>
			 <tr>
			  <td>EmailID Official:</td>
			  <td><input type="text" name="editofficialemailid" size="30" value="<% = Rs1("officialemailid") %>"></td>
			 </tr>
			 <tr>
			  <td>EmailID Personal:</td>
			  <td><input type="text" name="editpersonalemailid" size="30" value="<% = Rs1("personalemailid") %>"></td>
			 </tr>
			 <tr>
			  <td>Type Of User</td>
			  <td>&nbsp;&nbsp;
			    <select name="edittypeofuser" style="width:185px">
			     <option><% = Rs1("typeofuser") %></option>
	        ...
	        <tr>
	         <td colspan="2" align="center">
	            <input type="submit" name="type" class="buttonc" value="Save User">
	         </td>
	        </tr>
	       </table>
	       </form>
    ...
    <tr height="500">
      ...
      <table border="1" align="center" width="500px" cellspacing="0" cellpadding="3" >
       <tr height="25" >
        <td align="center" bgcolor="#A7DBFB"><b>First Name</b></td>
        <td align="center" bgcolor="#A7DBFB"><b>Last Name</b></td>	 
     ...
     <% UserId = arrAllQueries(0,rowcounter) %>
       ...
       <td align="center"><a href="user.asp?type=Edit&editUserId=<% = UserId %>">Edit</a></td>
       <td align="center"><a href="addEditDeleteUser.asp?deleteUserId=<% = UserId %>" onclick="return DeleteAlert(this.href);">Delete</a></td>
    </tr>
     <%
       Next
      %>
      <tr>
       ...
       <% If Not firstRow = 0 Then %>
          <a href="user.asp?type=editOrDelete&page=previous&row=<% = firstRow %>"> &lt;&lt;Previous</a>
       <% End If %>
       <% = ((firstRow + 1) & " - " & (lastRow + 1) & " of " & (numRows + 1)) %>
       <% If Not numRows = lastRow Then %>
          <a href="user.asp?type=editOrDelete&page=next&row=<% = lastRow %>"> &gt;&gt;Next</a>
       <% End If %>
       </td>
     </tr>
     <% End If %>
