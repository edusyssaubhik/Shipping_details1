...
strQuery4  = "SELECT * FROM projITIL_feedbacks WHERE Id = '" &rqEdit& "'"
Rs4.Open strQuery4,ConnObj


'Query To retrive competitor for dropdown to edit
strQuery = "select * from projITIL_competitors WHERE country = '"&Country&"'"
...
<body><div id="htMap">
 <table border="1" cellspacing="0" cellpadding="8" class="dbborder" Width="600px" align="center" >
   <form name="course" action="projITIL-feedback-Recieved.asp" method="post">
