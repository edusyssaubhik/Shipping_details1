...
rqType = Request.QueryString("type")
 ...
 body = "<table width=""100%"" border=""0"" bgcolor=""#CCCCCC"" style=""margin:0px;0px;0px;0px;""><tr><td height=""45px"">&nbsp;</td></tr><tr><td><table width=""600"" border=""0"" align=""center"" cellpadding=""2"" cellspacing=""12"" bgcolor=""#FFFFFF""><tr><td width=""600px"" bgcolor=""#FFFFFF""><span>" 
                       ...
                       body= body & "<span><img src=""http://www.PROJstudy.com/images/banners/email_headerUK-ITIL.jpg"" alt=""PROJstudy"" /></span>" 
  ...
  body = body & "<tr><td align=""left"" colspan=""2"" align=""center"">We are pleased to inform that you have passed the ITIL<sup>&reg;</sup> Foundation exam conducted on "&examdate1&" in "&courseDetails1&".You answered" 
   body = body & " "&Session("Marks")&" out of 40"

   body = body & " questions correctly.<br><br>Your ITIL<sup>&reg;</sup> Foundation certificate is under process and will soon be shipped by CSME at your mailing address.<br</td></tr>"
   
  body = body & "<tr><td align=""left"" colspan=""2"">We hope you enjoyed your experience with PROJstudy.If you liked our course structure and methodology, you can refer your friends for PROJstudy ITIL classroom courses.</td></tr>"  
  

   body = body & "<tr><td align=""left"" colspan=""2""><a href=""http://www.facebook.com/projstudy"" target=""_blank"">Stay connected to get more from PROJstudy on Facebook.</a></td></tr>" 
					

	 body = body & "<tr><td align=""left"" colspan=""2"">Click on the button to ""Refer Friend""</td></tr>"
	 body = body & "<tr><td align=""left"" colspan=""2""><form name=""referFriend"" action=""http://www.projstudy.com/insertReferFrnd.asp""  method=""post""><input type=""hidden"" name=""refEmailID"" value="&Session("EmailId")&"><input type=""hidden"" name=""refName"" value="&Session("FirstName")&">Friend`s Email:  <input type=""text"" name=""frndEmailID1"">&nbsp; &nbsp; Name(optional):  <input type=""text"" name=""frndName1""><br /><br>  Friend`s Email:  <input type=""text"" name=""frndEmailID2"">  &nbsp; &nbsp; Name(optional):  <input type=""text"" name=""frndName2"">  <br /><br>  Friend`s Email:  <input type=""text"" name=""frndEmailID3""> &nbsp; &nbsp;  Name(optional):  <input type=""text"" name=""frndName3""><br /><br /><div align=""center""><input type=""submit"" value=""Refer Friend"" /></div></form></td></tr>"  
	      ...
	      body = body & "<tr><td align=""left"" colspan=""2"">If you have any queries contact us at <a href=""mailto:itilinfo@projstudy.com"" target=""_blank"">itilinfo@projstudy.com.</a></td></tr>" 
   ...
   ElseIF  (Session("Marks") < "26" And (Session("courseType") = "Foundation" OR Session("courseType") = "Suite"))  Then
	    ...
	    body = body & "<tr><td align=""left"" colspan=""2"" align=""center"">We are sorry to inform that you could not clear the PROJstudy ITIL<sup>&reg;</sup> Foundation exam conducted on "&examdate1&" in "&courseDetails1&". You answered"
...
'Retrive The enrolluserid from this page'  
   ...
   rqSubject =  "PROJstudy ITIL Exam Result"
...
<title>PROJstudy ITIL Exam Result</title>
