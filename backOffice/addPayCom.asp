...
'response.Write(strQuery)
  ...
  ConnObj.Execute "UPDATE paymentDecline SET Status = '2' WHERE ID = '" & rqID &"'"
...
'response.Write(strQuery)
  ...
  ConnObj.Execute "UPDATE paymentDecline SET Status = '4' WHERE ID = '" & rqID &"'"
...
'response.Write(strQuery)
  ...
  ConnObj.Execute "UPDATE paymentDecline SET Status = '3', datePayment_rec ='"& now() &"' WHERE ID = '" & rqID &"'"
...
'response.Write(strQuery)
  ...
  ConnObj.Execute "UPDATE paymentDecline SET Status = '5' WHERE ID = '" & rqID &"'"
...
ElseIf rqType = "Save Comment" Then
 ...
 strQuery = "Insert Into enrolledusercomments (comment,enteredby,createddate,revlevel,enrolluserid)"
