...
<!--#include virtual="/includes/connection-ITIL.asp"-->
...
'Declare The Variables'
 ...
 Dim message
 Dim courseDate
 Dim strQuery,Rs1,Rs2,courseId,rs3,Rs4,Rs5,Rs6,Rs
...
If rqCourse = "pastcourses" Then 
	...
	strQuery = "SELECT courseid, city, startdate, enddate, status, coursetype, coursedates from PROJITIL_course WHERE certificateId = '3' and vendorId = '1' And country = '"& session("country") &"' AND  startdate < '"& Now() &"' order by startdate desc"

ElseIf (rqCourse = "futurecourses" OR rqCourse = "") Then 

	strQuery = "SELECT courseid, city, startdate, enddate, status, coursetype, coursedates from PROJITIL_course WHERE certificateId = '3' and vendorId = '1' And country = '"& session("country") &"' AND  startdate >= '"& Now() &"' order by startdate asc"
 ...
 %>
      ...
      <td><table  width="1800px" border="1" valign="top" cellspacing="0">
          <tr>
            ...
            <td bgcolor="#A7DBFB" align="center" width="50px"><b>Enrollment For</b></td>
       ...
       %>
          <form name="checkreceived" action="PROJITILenrolledDb.asp?type=review" method="post" onsubmit="return Form_Validator2(this)">
            <tr id="htMap">
              ...
              <% If  IsNULL(arrAllQueries(43,enrollrowcounter)) OR arrAllQueries(43,enrollrowcounter) = "" OR arrAllQueries(43,enrollrowcounter) = "1" Then %>
