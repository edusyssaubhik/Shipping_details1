...
<%
 ...
 Dim Rs2
 Dim City
 Dim rqcertification,rqRefNumber,rqCourseName,rqDuration,rqCapacity,rqDuration1
...
Dim rqeditedDuration1 , rqeditDurationType,rqDurationType
...
If addCourse= "Add Course" Then
  ...
  rqDuration1           =  Request.Form("Duration")
  rqDurationType       =  Request.Form("DurationType")
  ...
  rqDuration           =  rqDuration1 &" "&rqDurationType
...
If editCourse = "Edit Course" Then
 ...
 rqeditedDuration1     =  Request.Form("editedDuration")
 rqeditDurationType     =  Request.Form("editDurationType")
...
rqeditedDuration           =  rqeditedDuration1 &" "&rqeditDurationType
