...
'======================================================='
  ...
  strQuery = "SELECT * FROM proj_countrydetails WHERE country = '"& Session("country") &"' AND id = (SELECT MAX(id) FROM proj_countrydetails WHERE country = '"& Session("country") &"')"
...
'======================================================='
 ...
 If rqtype = "editCountryDetails" Then
   ...
   strQuery1 = "SELECT * FROM proj_countrydetails WHERE country = '"& Session("country") &"'"
    ...
    <table align="center" border="0" width="90%" cellpadding="5">
	 ...
	 <tr>
	  ...
	  <td><input type="text" name="applicabledays" /></td>
  	  <td align="right"><b>PRINCE2Manual :</b></td>
     ...
     <tr>
     <td colspan="2"><br /><br /><b>Foundation and Practitioner:</b></td>
     </tr>
	 <tr>
	  <td align="right"><b>Price :</b></td>
	  <td><input type="text" name="FPprice"></td>
  	  <td align="right"><b>EarlyBird Discount :</b></td>
	  <td><input type="text" name="FPEBDiscount"></td>
	 </tr>
	 <tr>
	  <td align="right"><b>After EarlyBird Discount Price :</b></td>
	  <td><input type="text" name="FPafterEBDiscountPrice" /></td>
  	  <td align="right"><b>Tax :</b></td>
	  <td><input type="text" name="FPtax"></td>
	 </tr>
     <tr>
     <td colspan="2"><br /><br /><b>Foundation :</b></td>
     </tr>
	 <tr>
	  <td align="right"><b>Price :</b></td>
	  <td><input type="text" name="Founprice"></td>
  	  <td align="right"><b>EarlyBird Discount :</b></td>
	  <td><input type="text" name="FounEBDiscount"></td>
	 </tr>
	 <tr>
	  <td align="right"><b>After EarlyBird Discount Price :</b></td>
	  <td><input type="text" name="FounafterEBDiscountPrice" /></td>
  	  <td align="right"><b>Tax :</b></td>
	  <td><input type="text" name="Fountax"></td>
	 </tr>
     <tr>
     <td colspan="2"><br /><br /><b>Practitioner:</b></td>
     </tr>
	 <tr>
	  <td align="right"><b>Price :</b></td>
	  <td><input type="text" name="Pracprice"></td>
  	  <td align="right"><b>EarlyBird Discount :</b></td>
	  <td><input type="text" name="PracEBDiscount"></td>
	 </tr>
	 <tr>
	  <td align="right"><b>After EarlyBird Discount Price :</b></td>
	  <td><input type="text" name="PracafterEBDiscountPrice" /></td>
  	  <td align="right"><b>Tax :</b></td>
	  <td><input type="text" name="Practax"></td>
	 </tr>
     
	 <tr>
	  <td align="right"><br /><br /><b>Start Time :</b></td>
	  <td><br /><br /><input type="text" name="starttime" /></td>
  	  <td align="right"><br /><br /><b>End Time :</b></td>
	  <td><br /><br /><input type="text" name="endtime" /></td>
	 </tr>     
	 <tr>
       ...
       <form action="addEditDeleteCountryDetails.asp" method="post" onsubmit="return Form_Validator1(this)">
		<table align="center" border="0">
		 ...
		 <tr>
		  ...
		  <td align="right"><b>PRINCE2Manual :</b></td>
		  <td><input type="text" name="pmbok" value="<% = Rs1("PRINCE2Manual") %>"></td>
		 </tr>
		 <tr>
		  <td align="right"><b>ClassroomCourse Phone Number1 :</b></td>
         ...
         <tr>
          <td align="right"><b>Price :</b></td>
          <td><input type="text" name="FPprice" value="<% = Rs1("FPprice") %>" /></td>
          <td align="right"><b>EarlyBird Discount :</b></td>
          <td><input type="text" name="FPEBDiscount" value="<% = Rs1("FPEBDiscount") %>" /></td>
         </tr>
         <tr>
          <td align="right"><b>After EarlyBird Discount Price :</b></td>
          <td><input type="text" name="FPafterEBDiscountPrice" value="<% = Rs1("FPafterEBDiscountPrice") %>" /></td>
          <td align="right"><b>Tax :</b></td>
          <td><input type="text" name="FPtax" value="<% = Rs1("FPtax") %>" /></td>
         </tr>
           <tr>
          <td colspan="2"><br /><br /><b>Foundation</b></td>
         </tr>
         <tr>
          <td align="right"><b>Price :</b></td>
          <td><input type="text" name="Founprice" value="<% = Rs1("Founprice") %>" /></td>
          <td align="right"><b>EarlyBird Discount :</b></td>
          <td><input type="text" name="Founebdiscount" value="<% = Rs1("FounEBDiscount") %>" /></td>
         </tr>
         <tr>
          <td align="right"><b>After EarlyBird Discount Price :</b></td>
          <td><input type="text" name="FounafterEBDiscountPrice" value="<% = Rs1("FounAfterEBDiscountPrice") %>" /></td>
          <td align="right"><b>Tax :</b></td>
          <td><input type="text" name="Fountax" value="<% = Rs1("Fountax") %>" /></td>
         </tr>
           <tr>
          <td colspan="2"><br /><br /><b>Practitioner</b></td>
         </tr>
         <tr>
          <td align="right"><b>Price :</b></td>
          <td><input type="text" name="Pracprice" value="<% = Rs1("Pracprice") %>" /></td>
          <td align="right"><b>EarlyBird Discount :</b></td>
          <td><input type="text" name="PracEBDiscount" value="<% = Rs1("PracEBDiscount") %>" /></td>
         </tr>
         <tr>
          <td align="right"><b>After EarlyBird Discount Price :</b></td>
          <td><input type="text" name="PracafterEBDiscountPrice" value="<% = Rs1("PracafterEBDiscountPrice") %>" /></td>
          <td align="right"><b>Tax :</b></td>
          <td><input type="text" name="Practax" value="<% = Rs1("Practax") %>" /></td>
         </tr>
         <tr>
          <td align="right"><br /><br /><b>Start Time :</b></td>
          <td><br /><br /><input type="text" name="starttime" value="<% = Rs1("starttime") %>" /></td>
          <td align="right"><br /><br /><b>End Time :</b></td>
          <td><br /><br /><input type="text" name="endtime" value="<% = Rs1("endtime") %>" /></td>
         </tr>              
		 <tr>
		  <td align="right" valign="top"><b>Payments :</b></td>
  ...
  <td valign="top">
   <table border="0" align="center" width="90%" cellspacing="5" cellpadding="2">
         ...
         <tr>
          ...
          <td><% = Rs("FPprice") %></td>
          <td align="right"><b>EarlyBird Discount :</b></td>
          <td><% = Rs("FPEBDiscount") %></td>
         </tr>
         <tr>
          <td align="right"><b>After EarlyBird Discount Price :</b></td>
          <td><% = Rs("FPafterEBDiscountPrice") %></td>
          <td align="right"><b>Tax :</b></td>
          <td><% = Rs("FPtax") %></td>
         </tr> 
          <tr>
         ...
         <tr>
          ...
          <td><% = Rs("Founprice") %></td>
          <td align="right"><b>EarlyBird Discount :</b></td>
          <td><% = Rs("FounEBDiscount") %></td>
         </tr>
         <tr>
          <td align="right"><b>After EarlyBird Discount Price :</b></td>
          <td><% = Rs("FounAfterEBDiscountPrice") %></td>
          <td align="right"><b>Tax :</b></td>
          <td><% = Rs("Fountax") %></td>
         </tr>   
          <tr>
         ...
         <tr>
          ...
          <td><% = Rs("Pracprice") %></td>
          <td align="right"><b>EarlyBird Discount :</b></td>
          <td><% = Rs("PracEBDiscount") %></td>
         </tr>
         <tr>
          <td align="right"><b>After EarlyBird Discount Price :</b></td>
          <td><% = Rs("PracafterEBDiscountPrice") %></td>
          <td align="right"><b>Tax :</b></td>
          <td><% = Rs("Practax") %></td>
         </tr>     
         <tr>
          <td align="right"><br /><br /><b>Start Time :</b></td>
          <td><br /><br /><% = Rs("starttime") %></td>
          <td align="right"><br /><br /><b>End Time :</b></td>
          <td><br /><br /><% = Rs("endtime") %></td>
         </tr>                  
		 <tr>
		  <td align="right" valign="top"><b>Payments :</b></td>
