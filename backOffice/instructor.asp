...
If session("brand") = "Datrix" OR session("brand") = "PROJstudy" then
 ...
 strQuery = "SELECT * FROM instructor WHERE country = '"& Session("country") &"' and vendorId = '"&Session("vendor")&"'"
            
ElseIf session("brand") = "All" then
             
 strQuery = "SELECT * FROM instructor WHERE country = '"& Session("country") &"'"
...
rqEdit = Request.Querystring("editInstructorId")
 ...
 strQuery1  = "SELECT * FROM instructor WHERE instructorid = '" & rqEdit & "'"
...
'And Display in Dropdown'
 ...
 strQuery2 = "SELECT distinct city FROM location WHERE country = '"& Session("country") &"'"
...
'Retrive The Maximum Revision Level from instructorcomments table'
...
'For Displaying all The Comments'
  ...
  strQuery3 = "SELECT max(revlevel) FROM instructorcomments WHERE instructorid =  '" & rqEdit & "'"
...
'Retriving The Maximum instructorid from instructor table'
  ...
  strQuery4 = "SELECT max(instructorid) FROM instructor"
...
'Display the Instructor Comments in edit instructor page'
 ...
 strQuery5 = "SELECT * FROM instructorcomments where instructorid =  '" & rqEdit & "'"
...
'Because CSR Only view the Instructor and add comments'
 ...
 strQuery6 = "SELECT * FROM instructor where instructorid =  '" & rqInstructorViewId & "'"

 Rs6.Open strQuery6,ConnObj

'Sql Query for Retrivng the instructor comments'

 strQuery7 = "SELECT * FROM instructorcomments where instructorid =  '" & rqInstructorViewId & "'"
		   ...
		   <td align="center" colspan="4" class="h3">Add Instructor</td>
	     	...
	     	<tr>
				...
				<td><input type="text" name="firstname"></td>
                    ...
                    <tr>
					 <td>Rate Per Day:</td>
					 <td><input type="text" name="Rate" maxlength="25"></td>
					</tr>
                    <tr>
					 <td>Type Of Instructor:</td>
					 <td><select name="insType"><option value="">--Select--</option><option value="Internal">Internal</option><option  value="Freelance">Freelance</option></select></td>
					</tr>
					<tr>
...
<td align="center" colspan="4" class="h3">Edit Instructor</td>
			...
			<% do until Rs1.EOF %>
			<input type="hidden" name="editinstructorid" value="<% = Rs1("instructorid") %>">
			<tr>
			...
			<tr>
			 <td>Email1:</td>
			 <td><input type="text" name="editemail1" value="<% = Rs1("email1") %>"></td>

			 <td>Email2:</td>
			 <td class=""><input type="text" name="editemail2" value="<% = Rs1("email2") %>"></td>
			</tr>
			<tr>
			 <td>Password:</td>
			...
			<tr>
			 <td>Company Name:</td>
			 <td><input type="text" name="editCompName" value="<% = Rs1("compname") %>">
			 </td>
			 <td>Company Address:</td>
			 <td><input type="text" name="editCompAdd" value="<% = Rs1("compadd") %>"></td>
			</tr>
				   <tr>
					<td class="zpCalSubheader">Address:</td>
					<td>
						<input type="text" name="editAdd" value="<% = Rs1("address") %>">
					</td>
   ...
   <tr>
    <td  colspan="4" align="center" class="h3">View Instructor</td>
	 ...
	 <!-- You Can Add Comment Of That Particular Instructor -->
 	 ...
 	 <input type="hidden" name="instructorId" value="<% = Rs6("instructorid") %>">
 	 <tr>
       <td><b>Comment:</b></td>
 ...
 <!-- All The Instructors Displaying Here -->
    <tr>
     <td valign="top" height="550">
      <table border="1" align="center" width="1200px" cellspacing="0" cellpadding="4">
       <tr height="25">
        ...
        <td bgcolor="#A7DBFB" align="center"><b>Email ID1</b></td>
          ...
          <td bgcolor="#A7DBFB" align="center"><b>Rate Per Day</b></td>
          <td bgcolor="#A7DBFB" align="center"><b>Type Of Instructor</b></td>
      ...
      <td><% = arrAllQueries(3,rowcounter) %></td>
          ...
          <td><% = arrAllQueries(14,rowcounter) %></td>
       <% if Session("typeofuser") = "Admin" or   Session("typeofuser") = "seniorCSR" Then %>
      ...
      <tr>
       ...
       <% If Not firstRow = 0 Then %>
          <a href="instructor.asp?type=editOrDelete&page=previous&row=<% = firstRow %>"> &lt;&lt;Previous</a>
       <% End If %>
       <% = ((firstRow + 1) & " - " & (lastRow + 1) & " of " & (numRows + 1)) %>
       <% If Not numRows = lastRow Then %>
          <a href="instructor.asp?type=editOrDelete&page=next&row=<% = lastRow %>"> &gt;&gt;Next</a>
       <% End If %>
       </td>
     </tr>
     <% End If %>
     <tr>
       <td colspan="14" align="center"><font face="Arial" size="2" color="orangered"><%=msg%></font></td>
     </tr>
   </table>
  </td>
 </tr>
