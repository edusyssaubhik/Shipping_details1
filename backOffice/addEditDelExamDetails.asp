...
If rqType = "Add" Then
 ...
 strQuery = "INSERT INTO liveclass_examdetails (city,examDate,examTime,CertificationID,VendorID)"
 ...
 Response.Redirect("examDetails.asp")
...
If rqType = "Edit" Then
 ...
 strQuery2 = "UPDATE liveclass_examdetails SET city = '"& rqEditCity &"', examDate = '" & rqEditExamDate & "', examTime = '" & rqEditExamTime & "' Where Examid = '" & rqEditExamid & "'"
...
If rqDelete <> "" Then
 ...
 strQuery3 = "DELETE FROM liveclass_examdetails WHERE Examid = '" & rqDelete & "'"
