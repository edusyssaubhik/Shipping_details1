...
'If You Adding New Competitor, Here We Are checking That Paricular rowcounter Available Or Not'
 strQuery1 = "SELECT Id,Competitor, country FROM competitors WHERE Competitor = '" & rqCompetitor & "'"
...
'If That Particular Competitor Not Added Then Insert Into DataBase'  
 Else
 strQuery = "INSERT INTO competitors(Competitor, country)"
...
strQuery = "UPDATE competitors SET"
...
'Query to delete Copetitor from database
 strQuery1 = "DELETE  FROM competitors WHERE Id = '" & rqDelete & "'"
