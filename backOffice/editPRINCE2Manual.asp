...
<%
  ...
  Sql = "select id,firstname,lastname,coursedetails,amount,PRINCE2Manual,PRINCE2price from enrolledusers where id = '"& rqId &"'"
 ...
 <tr>
 	<td valign="middle" height="100px">
		<table border="0" align="center" height="500"  bgcolor="#e7f2f7" cellpadding="5" >
			...
			<form name="EditPRINCE2ManualPrice" action="editPRINCE2ManualPrice.asp" method="post" onsubmit="return Form_Validate(this)">
			<% do until Rs.EOF %>
			<tr bgcolor="#ffffff">
