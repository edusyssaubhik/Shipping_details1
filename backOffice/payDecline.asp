...
Dim rqAction,rqId,rqType,rqPage,Rs,ps
...
strCity = "SELECT city FROM city ORDER BY city"
...
If rqAction = "noFollowUp" OR rqAction = "" Then
	...
	strPayDec = "SELECT ID, TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status , contactNo,Currency_type, Website, OrderNo FROM paymentDecline WHERE Status = '1' And city = '"& rqCity &"' ORDER BY ID desc"
	...
	strPayDec = "SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status , contactNo, Currency_type, Website, OrderNo FROM paymentDecline WHERE Status = '1' And (Name Like '%"& rqName &"%' OR EmailID Like '%"& rqName &"%') ORDER BY ID desc"
	
	ElseIf rqCourse <> "" Then

	'Retrive the not follow up details based on lastname'
	strPayDec = "SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status , contactNo, Currency_type, Website, OrderNo FROM paymentDecline WHERE Status = '1' And TypeofCourse Like '%"& rqCourse &"%' ORDER BY ID desc"
	
	'If user as a admin, i am showing all the cities'
	Else 
	
	'Retrive the not follow up details for all the cities (ADMIN)'
	strPayDec ="SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status, contactNo, Currency_type, Website, OrderNo  FROM paymentDecline WHERE Status = '1' ORDER BY ID desc"
...
ElseIf rqAction = "followUp" Then
	...
	'Retrive the not follow up details based on city search'
	strPayDec = "SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status , contactNo, Currency_type, Website, OrderNo FROM paymentDecline WHERE Status = '2' And city = '"& rqCity &"' ORDER BY ID desc"

	'If user entered name in the serach of Follow Up calls that will come here'
	ElseIf rqName <> "" Then

	'Retrive the follow up details based on lastname'
	strPayDec = "SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status,contactNo, Currency_type, Website, OrderNo  FROM paymentDecline WHERE Status = '2' And (Name Like '%"& rqName &"%' OR EmailID Like '%"& rqName &"%') ORDER BY ID desc"
	
	ElseIf rqCourse <> "" Then

	'Retrive the not follow up details based on lastname'
	strPayDec = "SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status  , contactNo, Currency_type, Website, OrderNo FROM paymentDecline WHERE Status = '2' And TypeofCourse Like '%"& rqCourse &"%' ORDER BY ID desc"
	...
	strPayDec = "SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status, contactNo, Currency_type, Website, OrderNo  FROM paymentDecline WHERE Status = '2' ORDER BY ID desc"
...
ElseIf rqAction = "closed" Then
	...
	strPayDec = "SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status,contactNo, Currency_type, Website, OrderNo FROM paymentDecline WHERE Status = '3' And city = '"& rqCity &"' ORDER BY ID desc"
	'If user entered name in the serach of Closed calls that will come here'
	ElseIf rqName <> "" Then

	'Retrive the Closed details based on lastname'
	strPayDec ="SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status, contactNo, Currency_type, Website, OrderNo FROM paymentDecline WHERE Status = '3' And (Name Like '%"& rqName &"%' OR EmailID Like '%"& rqName &"%') ORDER BY ID desc"
	
	ElseIf rqCourse <> "" Then

	'Retrive the not follow up details based on lastname'
	strPayDec = "SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status , contactNo, Currency_type, Website, OrderNo FROM paymentDecline WHERE Status = '3' And TypeofCourse Like '%"& rqCourse &"%' ORDER BY ID desc"
	...
	strPayDec = "SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status , contactNo, Currency_type, Website, OrderNo FROM paymentDecline WHERE Status = '3' ORDER BY ID desc"
...
ElseIf rqAction = "notInterested" Then
	...
	'Retrive the closed details based on city search'
	strPayDec = "SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status, contactNo, Currency_type, Website, OrderNo  FROM paymentDecline WHERE Status = '4' And city = '"& rqCity &"' ORDER BY ID desc"
	'If user entered name in the serach of Closed calls that will come here'
	ElseIf rqName <> "" Then

	'Retrive the Closed details based on lastname'
	strPayDec ="SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status , contactNo, Currency_type, Website, OrderNo FROM paymentDecline WHERE Status = '4' And (Name Like '%"& rqName &"%' OR EmailID Like '%"& rqName &"%') ORDER BY ID desc"
	'If user as a admin, i am showing all the cities'
	
	ElseIf rqCourse <> "" Then

	'Retrive the not follow up details based on lastname'
	strPayDec = "SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status , contactNo, Currency_type, Website, OrderNo FROM paymentDecline WHERE Status = '4' And TypeofCourse Like '%"& rqCourse &"%' ORDER BY ID desc"
	
	
	Else 

	'Retrive the Closed payment details for all the cities (ADMIN)'
	strPayDec = "SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status, contactNo, Currency_type, Website, OrderNo FROM paymentDecline WHERE Status = '4' ORDER BY ID desc"
...
ElseIf rqAction = "PayDummy" Then
	...
	'Retrive the not follow up details based on city search'
	strPayDec = "SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status , contactNo, Currency_type, Website, OrderNo FROM paymentDecline WHERE Status = '5' And city = '"& rqCity &"' ORDER BY ID desc"

	'If user entered name in the serach of Follow Up calls that will come here'
	ElseIf rqName <> "" Then

	'Retrive the follow up details based on lastname'
	strPayDec = "SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status,contactNo, Currency_type, Website, OrderNo  FROM paymentDecline WHERE Status = '5' And (Name Like '%"& rqName &"%' OR EmailID Like '%"& rqName &"%') ORDER BY ID desc"
	
	ElseIf rqCourse <> "" Then

	'Retrive the not follow up details based on lastname'
	strPayDec = "SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status  , contactNo, Currency_type, Website, OrderNo FROM paymentDecline WHERE Status = '5' And TypeofCourse Like '%"& rqCourse &"%' ORDER BY ID desc"
	...
	'Retrive the follow up details for all the cities (ADMIN)'
	strPayDec = "SELECT ID,TypeofCourse, Name,EmailID, city, Country, InvoiceDate, datePayment_dec,FailureReason,Amount,Addedby,AddedDate,PayProcess_name,datePayment_rec,Status, contactNo, Currency_type, Website, OrderNo  FROM paymentDecline WHERE Status = '5' ORDER BY ID desc"
...
strPayDec	 = "SELECT * FROM enrolledusers WHERE us_status = 'P.O Received' AND (checkreceived Is Null OR checkreceived <> 'Yes') And (status = 'Active' OR status = 'Re-Schedule Not Confirmed') ORDER BY id desc"

objRs1.Open strPayDec, ConnObj
...
End If
 ...
 strQuery5 = "SELECT comment FROM enrolledusercomments where enrolluserid =  '" & rqEnrollUserId & "'"
...
<tr>
  ...
  <% ElseIf rqAction = "noFollowUp" OR  rqAction = "" OR  rqAction = "followUp" OR  rqAction = "closed" OR rqAction = "notInterested" OR rqAction = "PayDummy" Then %>
    ...
    <tr>
      <td bgcolor="#A7DBFB" align="center"><b>SrNo</b></td>
      <td bgcolor="#A7DBFB" align="center"><b>Website</b></td>
    ...
    <td><% = arrAllRecords(18,rowcounter) %></td>
    ...
    <% Next %>
    <tr id="htMap">
      <td colspan="17"><!--#include virtual="/pagination.asp"-->
