...
strQuery ="SELECT Courseid,mailSent from PROJITIL_feedbackMail where Courseid ='"&Courseid1&"'"
...
strQuery1 = "Insert INTO  PROJITIL_feedbackMail ( MailSent,courseid ) values ('1', '"&Courseid1&"')"
Rs1.Open strQuery1,ConnObj
Session("message") = "You Have Successfully Sent Mail To Faculty"
Response.Redirect("projITIL-feedback-form.asp?courseId="&Courseid1)
Else
