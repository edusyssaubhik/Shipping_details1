...
If rqEmail <> ""  then 
strQuery = "SELECT * FROM PaypalDB WHERE address_country =  '"&rqCountryOrigin&"' And payer_email like '%"&rqEmail&"%' AND date_entered BETWEEN  '"&CDate(rqSrNo)&"' AND '"&CDate(rqSrNo2)&"' and (item_name like '%Free Trial - Test 1%' or item_name like '%Understand PRINCE2 Exam%' or item_name like '%PROJstudy Free Trial - Test 1%') ORDER BY date_entered desc"

ElseIf rqFirstName <> "" Then
strQuery = "SELECT * FROM PaypalDB WHERE address_country =  '"&rqCountryOrigin&"' And first_name like '%"&rqFirstName&"%' AND date_entered BETWEEN  '"&CDate(rqSrNo)&"' AND '"&CDate(rqSrNo2)&"' and (item_name like '%Free Trial - Test 1%' or item_name like '%Understand PRINCE2 Exam%' or item_name like '%PROJstudy Free Trial - Test 1%') ORDER BY date_entered desc"

ElseIf rqLastName <> "" Then
strQuery = "SELECT * FROM PaypalDB WHERE address_country =  '"&rqCountryOrigin&"' And last_name like '%"&rqLastName&"%' AND date_entered BETWEEN  '"&CDate(rqSrNo)&"' AND '"&CDate(rqSrNo2)&"' and (item_name like '%Free Trial - Test 1%' or item_name like '%Understand PRINCE2 Exam%' or item_name like '%PROJstudy Free Trial - Test 1%') ORDER BY date_entered desc"

Else
	strQuery = "SELECT * FROM PaypalDB WHERE address_country =  '"&rqCountryOrigin&"' AND date_entered BETWEEN  '"&CDate(rqSrNo)&"' AND '"&CDate(rqSrNo2)&"' and (item_name like '%Free Trial - Test 1%' or item_name like '%Understand PRINCE2 Exam%' or item_name like '%PROJstudy Free Trial - Test 1%') ORDER BY date_entered desc"
