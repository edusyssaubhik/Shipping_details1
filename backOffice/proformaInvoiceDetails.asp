...
'======================================================='
 ...
 Dim strQuery,viewQuestionNo,i,PIFBdicount
...
'======================================================='
  ...
  strQuery = "select * from enrolledusers where id =  '" & rqEnrollUserId & "'"
...
'response.Write(strQuery)
   ...
   strQuery1 = "select startdate,enddate,city,courseName,pricewithouttax,tax,startdate from course where courseid =  '" & rqCourseId & "'"
...
function calculate() { 
	...
	else if (discounttype == "FBdiscount")
	{
	
		var PIFBdicount = document.proformaInvoiceDetails.discountText.value;
		var x = (piamount - PIFBdicount);
		var priceafterdiscount = Math.ceil(x)
		var pricewithtax = Math.ceil(priceafterdiscount)
...
<table border="1" height="550" cellspacing="0" class="dbborder" width="1000px">
 ...
 <tr>
 	<td>
		<form name="proformaInvoiceDetails" action="proformaInvoiceDetails.asp?Type=New" 
						...
						<tr bgcolor="#ffffff">
							...
							Discount Type : &nbsp;&nbsp;&nbsp;
							   <select name="discountType" id="discountType" onchange="calculate();">
                                 ...
                                 <option value="FBdiscount">Facebook Discount</option>
							   </select>
	...
	<tr>
		<td>
			<table align="center" width="500px" height="400px" border="0">
				...
				<form action="newProformaInvoiceMail.asp" method="post">
                ...
                <input type="hidden" name="PIFBdicount" value="<% =rqDicounttext  %>" />
