...
'===============================================================================================================================================================================
 ...
 Dim strBrand,rqVendor,rqITILVendor,Rs13
...
If session("certificate") <> "" Then
			 ...
			 str = "Select top 1 * from certification where CertName = '"&session("certificate")&"' order by Cer_ID desc"
			 'response.Write(str)
...
'Sql Query For Retrive The course Details'
  ...
  If session("brand") = "All" And session("certificate") = "" then
		...
		strQuery =  "SELECT courseid,courseName,city,startdate,enddate,status,coursetype,certificateId from datrixClasses WHERE country = '"& session("country") &"' AND  startdate < '"& Now() &"' AND  certificateId = '"& session("certificateID") &"'  order by startdate desc"
...
'===============================================================================================================================================================================
 ...
 'response.Write("test")
		...
		strQuery = "SELECT courseid,courseName,city,startdate,enddate,status,coursetype,certificateId from datrixClasses WHERE country = '"& session("country") &"' AND  startdate >= '"& Now() &"' AND  certificateId = '"& session("certificateID") &"' order by startdate asc"
		 
			 
ElseIf session("brand") = "All" And session("certificate") <> ""  then
					
		
		strQuery = "SELECT DISTINCT courseid,courseName,city,startdate,enddate,status,coursetype,certificateId from datrixClasses WHERE country = '"& session("country") &"' And startdate >= '"& Now() &"' AND  certificateId = '"& session("certificateID") &"' order by startdate asc"
...
'response.Write(rqCourseId)
   If session("certificate") <> "" then
		 ...
		 strCertificate = "Select top 1 * from certification where CertName = '"&rqCertificate&"' order by Cer_ID desc"
		 ...
		 Rs13.close()
			...
			strQuery1 = "SELECT DISTINCT courseid,courseName,city,startdate,enddate,starthour,startminute,startsession,endhour,endminute,endsession,instructor,backupinstructor,applicabledays,hotelname,hotelphonenumber,hotelurl,hoteladdress FROM datrixClasses WHERE courseid = '"& rqCourseId &"'"
...
'===============================================================================================================================================================================-->
    ...
    <tr id="htMap">
      <td  height="25px" > <a href="PROJDatrixClass.asp?Course=PastCourses&certificate=<% = rqCertificate %>">Past Classes</a> | <a href="PROJDatrixClass.asp?Course=FutureCourses&certificate=<% = rqCertificate %>">Future Classes</a> | <a href="PROJDatrixClass.asp?type=selectcourse"><span style="color:#FF3300">Change certification type</span></a></td>
    </tr>
...
'===============================================================================================================================================================================-->
 ...
 <tr>
        ...
        <td><b>Classes:</b></td>
 			<td colspan="11"><select name="CourseId" id="courses" style="width:350px">
             <option value="">-- Select --</option>
...
'===============================================================================================================================================================================-->
        ...
        <tr height="25">
              ...
              <td bgcolor="#A7DBFB" align="center"><b>Revenue</b></td>
              <td bgcolor="#A7DBFB" align="center"><b>Costs</b></td>
              <td bgcolor="#A7DBFB" align="center"><b>Margin</b></td>
              <td bgcolor="#A7DBFB" align="center"><b>Profit(%)</b></td>
   ...
   <tr id="htMap">
    ...
    <tr id="htMap">
      ...
      <tr>
          <td colspan="12"><div align="center"><font face="Arial" size="2" color="orangered"><%=message%></font></div></td>
      </tr>
...
<!-------------------------------------------------------------------------------Brand----------------------------------------------------------------------->           
			  <td align="center"><% If arrAllQueries(59,enrollrowcounter) = "2" or arrAllQueries(60,enrollrowcounter) = "2" Then %>Datrix<% Else %>PROJstudy<% End If %></td>
