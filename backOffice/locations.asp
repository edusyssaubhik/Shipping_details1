...
Rs2.Open strCity, ConnObj
  ...
  strQuery = "select id, location, imageName, locationaddress, country, hotelName,Region,phoneNo,Postcode,capacity,park_info,type,Faculty_notes,book_info from proj_locations where country = '"& Session("country") &"' and vendorId = '"&Session("vendor")&"'  order by location"
...
'======================================================='
 ...
 If rqtype = "edit" Then
   ...
   strQuery1 = "SELECT id,location,imagename,locationaddress,country, hotelName,Region,phoneNo,Postcode,capacity,park_info,type,Faculty_notes,book_info FROM proj_locations WHERE id = '" & rqLocationId & "'"
...
<body><div id="htMap">
<table border="1" height="550" cellspacing="0" class="dbborder" width="1100px">
 <tr>
    ...
    <table align="center" border="0" cellpadding="5" cellspacing="5">
     ...
     <tr>
      ...
      <% if  session("brand") = "Datrix" then %>
       ...
       <input type="text" name="location" onchange="FindLocaiton(this.value)">
     ...
     <tr>
      ...
      <option value="">-----Select-----</option>
        ...
        <option value="Yorkshire">Yorkshire</option>
            ...
            <tr>
       <td><b>Add Capacity</b></td>
	  <td>
          <input type="text" name="capacity" /></td></tr>
  
       <% End if %>
       
       
       <tr> <td><b>Hotel Name:</b></td>
	 ...
	 <tr>
	  <td><b>Address:</b></td>
	  <td><textarea name="locationAddress" onchange="FindLocaiton(this.value)"></textarea> <% if  session("brand") = "Datrix" then %><br />("Ex:Unit 5 Albert Edward House,(Add break tag)The Pavillions,(Add break tag) Ashton-On-Ribble,(Add break tag)PR2 2YB")<% End if %></td>
	 </tr>
   ...
   <tr><td><b>Phone No.:</b></td>
	...
	<% End if %> 
     ...
     <tr>
	  ...
	  <td><input type="text" name="imgName" style="margin-left:1px" /> <br />(Ex: imagename.jpg or imagename.gif(seperate multiple images by ,)</td>
	 </tr>	 
     <tr>
      <td>&nbsp;</td>
     </tr>
    <tr>
        <tr><td>Parking Information</td>
            <td><input type="text" name="park" /></td>
            
        </tr>
        
        <tr><td>Travel Directions </td>
            <td><div id ="map" style="height: 264px; width: 493px;" >
   </div>
   </td>
         ...
         <tr><td>Type</td>
            <td><select name="type" style="width: 140px">
                <option value="Edusys">Edusys</option>
                <option value=" Partner_Venue"> Partner Venue</option>
            
                    </select></td>
            
        </tr>
        <tr><td>Faculty Notes</td>
            <td><input type="text" name="note" /></td>
            
        </tr>
        <tr><td>Booking Info</td>
     ...
     <td height="200">
       <form action="addEditDeleteLoc.asp" method="post" onsubmit="return validate_form1(this)">
		<table align="center" border="0" cellpadding="5" cellspacing="5" width="100%">
	     <tr>
		  <td align="center" colspan="8" height="40" class="h3">Edit Location</td>
         </tr>
		 <% do until Rs1.EOF %>
	
		 <tr>
         
           <td style="width:430px;"><b>Location :</b></td>
          
            <td > 
          <% if  session("brand") = "Datrix" then %>
      
      <input type="text" name="location" value="<% = Rs1("location") %>" onchange="FindLocaiton(this.value)">
 ...
 <tr>
       <td><b>Region:</b></td>
	  <td><select id="editRegion" name="editRegion">
      <option value="">-----Select-----</option>
        <option <% If  Rs1("Region") = "East" then %> selected="selected" <% End if %> value="East">East</option>
        <option <% If  Rs1("Region") = "East Midlands" then %> selected="selected" <% End if %> value="East Midlands">East Midlands</option>
        <option <% If  Rs1("Region") = "London" then %> selected="selected" <% End if %> value="London">London</option>
        <option <% If  Rs1("Region") = "North East" then %> selected="selected" <% End if %> value="North East">North East</option>
        <option <% If  Rs1("Region") = "North West" then %> selected="selected" <% End if %> value="North West">North West</option>
        <option <% If  Rs1("Region") = "Scotland" then %> selected="selected" <% End if %> value="Scotland">Scotland</option>
        <option <% If  Rs1("Region") = "South East" then %> selected="selected" <% End if %> value="South East">South East</option>
        <option <% If  Rs1("Region") = "South West" then %> selected="selected" <% End if %> value="South West">South West</option>
        <option <% If  Rs1("Region") = "Wales" then %> selected="selected" <% End if %> value="Wales">Wales</option>
        <option <% If  Rs1("Region") = "West Midlands" then %> selected="selected" <% End if %> value="West Midlands">West Midlands</option>
        <option <% If  Rs1("Region") = "Yorkshire" then %> selected="selected" <% End if %> value="Yorkshire">Yorkshire</option>
     </select></td></tr>
       
       
       
       <tr><td> <b>Capacity</b></td>
          <td><input type="text" name="editCapacity" value="<% = Rs1("capacity") %>" /><br /></td>
</tr>
<% End if %>
      <tr>  
	 ...
	 <td><input type="text" name="hotelName" value="<% = Rs1("hotelName") %>"></td>
         	 ...
         	 <tr>
	 	    <td><b>Address :</b></td>
			<td><textarea type="text" name="locationAddress"  style="margin-left:1px"  onchange="FindLocaiton(this.value)"/><% =Rs1("locationaddress") %></textarea></td>
		 </tr>	
   ...
   <tr><td><b>Phone No.:</b></td>
    ...
    <% if  session("brand") = "Datrix" then %>
             ...
             <tr>
        <tr><td>Parking Information</td>
            <td><input type="text" name="park"  value="<% = Rs1("park_info") %>"/></td>
        ...
        <tr><td>Travel Directions </td>
         ...
         <tr><td>Type</td>
            <td><select name="editType" style="width: 140px">
                <option value="Edusys" <% If Rs1("type") = "Edusys" then %> selected="selected" <% End if %> >Edusys</option>
                <option value="Partner_Venue" <% If Rs1("type") = "Partner_Venue" then %> selected="selected" <% End if %>> Partner Venue</option>
            
                    </select></td>
            
        </tr>
        <tr><td>Faculty Notes</td>
            <td><input type="text" name="note"  value="<% = Rs1("Faculty_notes") %>"/></td>
            
        </tr>
        <tr><td>Booking Info</td>
            <td><input type="text" name="book" value="<% = Rs1("book_info") %>"/></td>
        </tr>
  ...
  <td valign="top">
   <table border="1" align="center" width="400px" cellspacing="0" cellpadding="2">
	<tr height="25">
     ...
     <td bgcolor="#A7DBFB" align="center"><b>Parking Information</b></td>
     <td bgcolor="#A7DBFB" align="center"><b>Type</b></td>
      <td bgcolor="#A7DBFB" align="center"><b>Faculty Notes</b></td>
       <td bgcolor="#A7DBFB" align="center"><b>Booking Info</b></td>
       <% End if %> 
	 ...
	 <td><% = arrAllQueries(5,rowcounter) %></td>	 
      <td><% = arrAllQueries(3,rowcounter) %></td>	 
       ...
       <td><% = arrAllQueries(9,rowcounter) %></td>	 
	    ...
	    <td><% = arrAllQueries(12,rowcounter) %></td>
	...
	<% Next %>
	 <tr id="htMap">
              <td colspan="16"><!--#include virtual="/backoffice/pagination.asp"-->
               <% 
	...
	<% End If %>
	<tr>
	  <td colspan="16" align="center"><font face="Arial" size="2" color="orangered"><%=message%></font></td>
	</tr>
  </table>
 </td>
</tr>
