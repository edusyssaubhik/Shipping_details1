...
'Currency Format Display Functions'
 ...
 'Retrive Values'  
	...
	PIFBdicount         = Request.Form("PIFBdicount")
...
IF PIFBdicount = "5" Then

priceAfterDiscount = priceAfterDiscount + 5
...
End If
	...
	strQuery1 = "Update enrolledusers Set" 
	If (Session("Country") = "United Kingdom" OR Session("Country") = "India" OR  Session("country") = "Australia") Then
 	strQuery1 = strQuery1 & " amount = '"& priceAfterDiscount &"', VAT = '"& VAT &"'"
	Else
 	strQuery1 = strQuery1 & " amount = '"& priceWithTax &"'"
	End If
	If (Session("Country") = "United Kingdom" and PIFBdicount = "5") Then
 	strQuery1 = strQuery1 & " ,FBdiscount = '"& PIFBdicount &"'"
	End If
...
'response.Write(strQuery1)
 ...
 'Inserting Reviced invoice details'
 
 ConnObj.Execute "INSERT INTO reviced_invoice_details(enrollid,invoice_sentby,invoice_sentdate) values('"&PICode&"','"&Session("UserId")&"','"&now()&"')"
...
body = "<table width=""100%"" bgcolor=""#CCCCCC"" style=""margin:0px;0px;0px;0px;""><tr height=""45px""><td>&nbsp;</td></tr><tr><td><table width=""600px"" border=""0"" align=""center"" cellpadding=""2"" cellspacing=""12"" bgcolor=""#FFFFFF""><tr><td width=""595px"" bgcolor=""#FFFFFF"">" 
	  ...
	  body = body & "<tr><td><font face=""Arial"" size=""2""><b>PROJstudy PRINCE2 Classroom Training <br>" & newCourseDetails & "</b>"
...
End If
'Face book discount
If (Session("CountryOrigin") = "United Kingdom") And PIFBdicount = "5" Then
...
body = body & "</b></font></td></tr></table><br></td></tr>"					   
   ElseIf Session("country") = "United Kingdom" OR Session("country") = "Australia" Then 
	...
	body = body & "&nbsp;&nbsp;<a href=""http://www.PROJstudy.com/payment.asp?enrollUserID="& PICode &"&Country="& Session("Country") &""" target= ""_blank""><font face=""Arial"" size=""3"" color=""#0359b4""><b>Buy Now</b></font></a></li>"
	
	ElseIf Session("Country") = "Australia"  Then
	body = body & "<li><font face=""Arial"" size=""4""><b>Paypal</b></font>&nbsp;&nbsp;&nbsp;&nbsp;<a href=""http://www.PROJstudy.com/payment.asp?enrollUserID="& PICode &"&Country="& Session("Country") &"""><font face=""Arial"" size=""3"" color=""#0359b4""><b>Buy Now</b></font></a></li>"
	ElseIf Session("Country") = "India" Then
	body = body & "<ul type=""disc""><li> <span>Cheque</span> or <span > Demand Draft</span> favouring <span> ""Edusys Services Private Limited.""</span><br /><br /><span>This should be couriered to the following address:</span><br /><br /><span>Edusys Services Private Limited</span>,<br>#27,2<sup>nd</sup> Floor</br>Santosh Towers,<br />J.P. Nagar 4<sup>th</sup> Phase,<br>4<sup>th</sup> Main,100 Ft. Ring Road<br>Bangalore 560078<br />India<br /><br />Ph:+91 80 4155 75 47/48/49<br><br /></li><li><span>Bank Transfer: </span><span >Payee Name:  </span>EDUSYS SERVICES PVT. LTD.<br /><span>Bank Name :  </span>ICICI Bank Limited<br /><span>Account Number :  </span>ICICI Bank A/c No : 0401 0500 0128<br /><span>IFSC Code:</span> ICIC0000401<br><span>Branch Name :  </span>ICICI Bank, J.P. Nagar Branch, Bangalore<br /><br /></li><li><font face=""Arial"" size=""2""><b>Payment through Credit card or Debit card:</b></font>&nbsp;&nbsp;<a href=""http://www.mycatstudy.com/projstudy_makepayment.asp?enrollUserID="& Session("EnrollId") &"&Country="& Session("CountryOrigin") &"""><font face=""Arial"" size=""3"" color=""#0359b4""><b>Buy Now</b></font></a><br><br></li>"
	
	 body = body & "<li><span>Alternate Payment Mechanism: </span>If you have problems in making payments through Cheque or Demand Draft, please email us at marketing@projstudy.com; we will suggest alternate payment options to you.</li></ul></td></tr>"
	  End If
	   If Session("country") = "India" Then
	  ...
	  body = body & "<tr><td align=""left"" colspan=""2""><font face=""Arial"" size=""2""><br>Please Note:You will be allowed access to the free 100% Online Preparatory Course for <a href=""http://www.PROJstudy.com"" target=""_blank"">PROJstudy.com</a> Classroom Course only after we receive your payment : this is a simple online course which can be completed with a few hours of study. This course is a pre-requisite for PROJstudy.com Classroom Course."
	   If Session("Country") = "United Kingdom" OR Session("Country") = "Australia" Then 
      body = body & "<b> Details:</b><a href=""http://www.PROJstudy.com/PRINCE2-Training/examRetakeGuarantee.asp"" target=""_blank"">Please refer to the free Exam Retake Guarantee Terms and Conditions.</font></td></tr>"  
	 ...
	 body = body & "<tr><td colspan=""3""><font face=""Arial"" size=2><b>PROJstudy.com.</b></font><br /><br/><hr><div align=""center""><font size=""1px"">"
	 If Session("country") = "India" Then
	body = body & "EDUsys Services Private Limited,<br>Santosh Towers,4th Main,100 Ft. Ring Road, J.P. Nagar 4th Phase,Bangalore - 560078, India<br>"
     End If
 body = body & "PRINCE2<sup>&reg;</sup> is a registered trade mark of the Cabinet Office.<br />The Swirl logo™ is a trade mark of the Cabinet Office.</font></div><br /></td></tr></table></td></tr><tr height=""30px""><td>&nbsp;</td></tr></table></td></tr><tr height=""45px""><td>&nbsp;</td></tr></table>"
	 'response.Write(body)
...
Set objCDOMail = Server.CreateObject("CDONTS.NewMail")
    ...
    objCDOMail.BCC = "financialsus@gmail.com,t_satpathy@yahoo.com"
    ElseIf (Session("country") = "United Kingdom" OR Session("country") = "Germany" OR Session("country") = "Australia") Then
    objCDOMail.BCC = "ukfinancialsedusys@gmail.com,t_satpathy@yahoo.com"
    ElseIf (Session("country") = "India") Then 
    objCDOMail.BCC = "indiafinancials@gmail.com,t_satpathy@yahoo.com"
    End If
...
<div id="htMap">
  <table width="700" height="580" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#00B0EC" class="dbborder" >
   <tr>
   <td colspan="9" height="35"><div align="center"><font color="#00B0EC" face="Arial" size="4">Welcome to <span style="color:#FF3300"><% =Session("country") %></span> PROJstudy Back Office</font></div>
 </tr>
 <tr>
 ...
 <tr>
      <td width="547" valign="top"><table width="100%" cellspacing="0" cellpadding="2">
          <form id="form1" name="form1" method="post" action="newProformaInvoiceMail.asp?type=preview">
          ...
          <form  method="post" action="newProformaInvoiceMail.asp?type=sendmail">
