...
strQuery = "SELECT courseid, courseName, city, startdate,enddate,status FROM course WHERE status = 'Cancelled' and  courseid = '" & rqEditCourseId &"' Order by courseid desc"
...
Do until objRs.EOF
	...
	'Retriving the last mail send date'
	strQuery = "SELECT id,firstname, lastname, email, nameofemployeer, coursedetails,cancel_sentMail FROM enrolledusers WHERE courseid = '" & rqEditCourseId &"' and checkreceived = 'Yes' Order by id desc"
