...
'Query for Display the study materials for perticuler user
strStudyMat = "SELECT * FROM proj_studymaterial WHERE added_by = '"&rqUser&"' ORDER BY id desc"
...
'Query for Display the gifts for perticuler user
strGifts = "SELECT * FROM proj_gifts WHERE added_by = '"&Session("User")&"'  ORDER BY id desc"
...
'Query for display the Miscellaneous for perticuler user
strMis = "SELECT * FROM proj_miscellaneous WHERE added_by = '"&Session("User")&"'  ORDER BY id desc"
