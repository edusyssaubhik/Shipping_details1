  ...
  <td height="200">
   <form action="addEditDeleteStaticCourse.asp" method="post" onsubmit="return Form_Validator(this)">
    <table align="center" border="0" cellpadding="5" cellspacing="5" width="800px">
	 ...
	 <tr>
      <td><b>Duration:</b></td>
      <td><input type="text" name="Duration">&nbsp;(eg: 2 Days (or) 2 hours)</td>
     </tr>
     <tr>
     ...
     <option value="<% = Rs11("Cer_ID") %>"><% = Rs11("CertName") %></option>
		 ...
		 <tr>
		  <td><b>Duration:</b></td>
		   ...
		   <td><input type="text" name="editedDuration" value="<% = Rs1("Duration") %>"> &nbsp;(eg: 2 Days (or) 2 hours)</td>
  ...
  <td valign="top">
   <table border="1" align="center" width="1000px" cellspacing="2" cellpadding="5">
	<tr height="25">
	 ...
	 <td bgcolor="#A7DBFB" align="center"><b>Ref Number</b></td>
	...
	<tr>
	 <td colspan="8">
	   <% If Not firstRow = 0 Then %>
		<a href="staticCourse.asp?type=editOrDelete&page=previous&row=<% = firstRow %>"> &lt;&lt;Previous</a>
	   <% End If %>
	   <% = ((firstRow + 1) & " - " & (lastRow + 1) & " of " & (numRows + 1)) %>
	   <% If Not numRows = lastRow Then %>
		<a href="staticCourse.asp?type=editOrDelete&page=next&row=<% = lastRow %>"> &gt;&gt;Next</a>
	   <% End If %>
	 </td>
	</tr>
	<% End If %>
