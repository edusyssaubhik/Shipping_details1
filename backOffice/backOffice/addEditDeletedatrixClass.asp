...
response.Write(Request.Form("addcourse"))
If addCourse = "Add Course" Then


 set rs1=server.CreateObject("adodb.recordset")	
 
 strQuery1="Select * from datrixClasses where city='"& rqCity &"' and startdate='"&rqStartDate&"' and enddate = '"&rqEndDate&"' AND RefNumber = '"&rqRefNumber&"' AND coursetype = '"& rqCourseType &"' AND certificateId = '"& session("certificateID") &"' and vendorId = '"&Session("vendor")&"'"	
