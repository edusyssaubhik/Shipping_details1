...
<meta http-equiv="content-type" content="text/xml; charset=utf-8" />
 <title>Feed Back Form</title> <link href="/backoffice/css/pagestyle.css" rel="stylesheet" type="text/css">
</head>
...
'creating record set 
 ...
 'query to retrive course details depending on CourseId and today's Date
	strQuery = "SELECT courseId, city, startdate, enddate, coursetype, coursedates,instructor from PROJITIL_course WHERE country = '"&Country&"' AND  startdate < '"& Now() &"' AND status <> 'Cancelled' order by startdate desc"
...
If rqCourseId <> "" Then
   strQuery2 = "SELECT id,firstname,lastname,courseid FROM PROJITIL_enrolledusers WHERE (checkreceived = 'Yes' OR us_status = 'Active' OR us_status = 'P.O Received' OR us_status = 'Under Process') AND courseid = '"& rqCourseId &"'"
...
strQuery5 ="SELECT courseid,city,startdate,enddate,instructor from PROJITIL_course where courseid = '"& rqCourseId &"' "
...
strQuery4 = "select * from PROJITIL_competitors  WHERE country = '"&Country&"'"
...
<% If rqCity ="" Then %>
  ...
  <table>
        ...
        <tr><form name="course" action="projITIL-feedback-form.asp" method="post"><td><b>Courses:</b></td>
...
<div style="overflow-y:scroll; overflow-x:hidden ">
     <table width="100%" border="0" cellspacing="0" cellpadding="0" id="tHeader" style="display:block; border-collapse:collapse;">
              ...
              <th colspan ="8" style="width:900px" scope="col">3 most important factors for considering ITILstudy? </th>
		 ...
		 <div style="overflow-y:scroll; height:300px ; width:100%">
		  <table border="0"  cellspacing="0" cellpadding="0"  id="tBody" style="display:block; border-collapse:collapse;">
		   ...
		   'Sql Query To Retrive values from the table if Enroll_ID and Course_ID eixts 
		    strQuery3 = "SELECT * FROM PROJITIL_feedbacks WHERE Course_ID = '"&arrAllQueries(3,enrollrowcounter)&"' and Enroll_ID = '"&arrAllQueries(0,enrollrowcounter)&"' "
	...
	<tr align="center">     
			...
			<td style="width:250px"> <Textarea name="enjoyedClass" rows="4" cols="25" readonly="readonly"><% =Rs3("impFactors_Others")%></Textarea></td>	
            ...
            <td style="width:250px"> <% =Rs3("Recommended_to_Others")%><br/><% If  Rs3("Recommended_to_Others") = "Yes" Then%> <Textarea name="enjoyedClass" rows="4" cols="25" readonly="readonly"><% =Rs3("RO_Comments")%></Textarea><%End If%></td>
			<td style="width:250px"> <Textarea name="enjoyedClass" rows="4" cols="25" readonly="readonly"><% =Rs3("Completed_Cert")%></Textarea></td>
			<td style="width:250px"> <Textarea name="enjoyedClass" rows="4" cols="25" readonly="readonly"><% =Rs3("Pursue_Cert")%></Textarea></td>			
            ...
            <td style="width:100px">&nbsp; </td>
            <td style="width:100px"><a href="projITIL-feedback-Edit.asp?type=Edit&Id=<% =Id %>">Edit</a></td>
          </tr>
         <%
		 ...
		 %> 
	  		  ...
	  		  <tr align="center">
               <form name="feedback" action="projITIL-feedback-Recieved.asp" method="post">
...
<td align="center"><% = AverageRating %><br/><a href="projITIL-feedback-Mail.asp?courseid=<% =rqCourseId %>"><span class="Error">Need to be Reported</span></a></td>
<% Else %>
