...
'===============================================================================================================================================================================-->
    ...
    <tr id="htMap">
      <td  height="25px" > <% If Session("typeofuser") <> "CSR" Then %><a href="courses.asp?type=add&certificate=<% = rqCertificate %>">Add Class </a> |  <% End If %> <a href="courses.asp?Course=PastCourses&certificate=<% = rqCertificate %>">Past Classes</a> | <a href="courses.asp?Course=FutureCourses&certificate=<% = rqCertificate %>">Future Classes</a> | <a href="courses.asp?type=selectcourse"><span style="color:#FF3300">Change certification type</span></a></td>
    </tr>
...
'===============================================================================================================================================================================-->
    ...
    <tr>
      ...
      <form name="addcourse" action="addEditDeleteCourse.asp" method="post" onsubmit="return Form_Validator(this)">
...
<form name="addcourse" action="addEditDeleteCourse.asp" method="post" onsubmit="return Form_Validator1(this)">
                ...
                <tr>
				  ...
				  <% if  (arrAllQueries(11,enrollrowcounter)  = "Yes") then%>
                          ...
                          <% End If %>
                            ...
                            Date <% =  arrAllQueries(12,enrollrowcounter)  %><br><br>
                            Received by <% = arrAllQueries(13,enrollrowcounter) %><br /><br />
