...
' If rqResCourseID <> "" Then
	...
	End If
	  ...
	  strQuery3 = "INSERT INTO enrolledusers (firstname,lastname,email,nameofemployeer,phoneno,coursedetails,coursedate,amount,dateofenrollment,paybefore,status,checkreceived,checkreceiveddate,checkreceivedby,PRINCE2Manual,PRINCE2price,statusnumber,courseid,discountpercentage,res_can_mbg_amount,VAT,street,city,state1,postalCode,speReq,"
...
'Retrive The CourseDates Page'
 ...
 If session("country") <> "" Then
 	...
 	strQuery4 = "SELECT * FROM course WHERE country = '"& session("country") &"' ORDER BY startdate desc"
