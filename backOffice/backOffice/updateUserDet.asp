...
'------------------------------------------------------'
 ...
 rqCountry      =   Request.Form("changeCountry")
  ...
  strQuery = "Select firstname, lastname, nameofemployeer, email, phoneno,street,city,state1,postalCode,country from enrolledusers  WHERE id = '"&rqEnrollUserId&"'"
...
Response.Redirect("courses.asp?courseId="&CourseId)
