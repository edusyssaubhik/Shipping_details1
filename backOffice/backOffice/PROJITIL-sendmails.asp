...
rqType = Request.QueryString("type")
	...
	strQuery = "SELECT firstname,lastname,email,coursedate FROM PROJITIL_enrolledusers WHERE courseid = '" & rqCourseId & "' AND ((checkreceived = 'Yes' AND status = 'Active') OR (us_status = 'P.O Received' And status = 'Active'))"
	...
	If rqType = "" Then
		...
		Loop
			...
			subject="Venue details for PROJstudy ITIL Classroom Training (www.PROJstudy.com)"
			body = "<font face=""Arial"" size=""2""><BR><BR>Greetings from PROJstudy<BR><BR>Thank you for selecting PROJstudy ITIL to assist you in preparing for the ITIL Foundation exam.<BR><BR>The program venue details are provided below: <BR><BR><B><U>Program Details</U></B><BR><BR>Program: PROJstudy ITIL Classroom Training<BR><BR>Duration: "& FormatDateTime(startDate,1) &" to "& FormatDateTime(endDate,1) &"<BR><BR>Class time: "&startingHour&":"&startingMinute&"&nbsp; "& startingSession &" - "& endingHour &":"& endingMinute &" &nbsp; "& endingSession &"<BR><BR><table border=""0"" cellpadding=""3""><tr><td valign=""top""><font face=""Arial"" size=""2"">Venue : </font></td><td><font face=""Arial"" size=""2"">"& hotelName &"<br>"& hotelAddress
		...
		body = body & "	We look forward to your active participation.<BR><BR>Best Regards,<BR>Customer Support<BR><a href=""http://www.PROJstudy.com"" target=""_blank"">www.PROJstudy.com</a><BR>Email id : itilinfo@projstudy.com</font></td></tr></table></td></tr><tr height=""30px""><td>&nbsp;</td></tr></table></td></tr><tr height=""45px""><td>&nbsp;</td></tr></table>"
...
If rqType = "sendmail" Then
   ...
   strQuery2 = "UPDATE PROJITIL_enrolledusers SET allmailsent = '1' WHERE courseid = '" & rqCourseId & "'"
	
   Rs2.Open strQuery2,ConnObj

   	strQuery3 = "SELECT firstname,lastname,email,coursedate FROM PROJITIL_enrolledusers WHERE courseid = '" & rqCourseId & "' AND ((checkreceived = 'Yes' AND status = 'Active') OR (us_status = 'P.O Received' And status = 'Active'))"
...
'		Else
	   ...
	   objCDOMail.Body = "<table width=""100%"" bgcolor=""#CCCCCC"" style=""margin:0px;0px;0px;0px;""><tr height=""45px""><td>&nbsp;</td></tr><tr><td><table width=""600px"" border=""0"" align=""center"" cellpadding=""2"" cellspacing=""12"" bgcolor=""#FFFFFF""><tr><td width=""595px"" bgcolor=""#FFFFFF""><span><img src=""http://www.PROJstudy.com/images/banners/email_headerUK-ITIL.jpg"" alt=""PROJstudy"" width=""600px"" height=""103"" /></span></td></tr><tr><td align=""center"" colspan=""2"" width=""560px""><table border=""0"" align=""center"" width=""560px""><tr><td><br><font face=""Arial"" size=""2"">Dear "& strFirstName &"&nbsp;"& strLastName &",</font>"& rqBody 
	   objCDOMail.Importance = 2
	   objCDOMail.Send
  ...
  <table width="620" height="580" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#00B0EC" class="dbborder" >
    <tr>
      <td width="547" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
          <form  method="post" action="PROJITIL-sendmails.asp?type=preview">
            ...
            <tr class="rowOdd">
              <td>Subject : </td>
              <td>Venue details for PROJstudy ITIL Classroom Training (www.PROJstudy.com)</td>
            </tr>
            <tr class="rowEven">
          ...
          <form method="post" action="PROJITIL-sendmails.asp?type=sendmail">
            <tr>
