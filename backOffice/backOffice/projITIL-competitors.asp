...
function Form_Validator(theform)
 ...
 Dim rqPage,allNumRows,iPageCurrent,arrAllRecords,rqCompetitors,Rs
...
'Query to retirve values from database
 strQuery = "SELECT * FROM PROJITIL_competitors where country = '"& Session("country") &"'"
...
strQuery1  = "SELECT * FROM PROJITIL_competitors WHERE Id = '" &rqEdit& "'"
...
<table border="1" width="1000" height="300" cellpadding="8" cellspacing="0" class="dbborder" >
 <tr>
   <td colspan="9" height="35" class="HeaderLarge"><div align="center"><font color="#00B0EC" face="Arial" size="4">Welcome to <span style="color:#FF3300"><% =Session("country") %></span> ITILstudy Back Office</font></div></td>
    ...
    <tr>
   <td height="25"><a href="projITIL-Competitors.asp?type=add">Add Competitor</a></td></tr>
   ...
   <tr>
	  <td>
	   <form action="projITIL-addEditDeletecompetitors.asp" method="post" onSubmit="return Form_Validator(this)">
  ...
  <% If rqType = "Edit"  Then %>
    ...
    <% End If %>
     ...
     <% Id = arrAllQueries(0,rowcounter) %>
       ...
       <td align="center"><a href="projITIL-competitors.asp?type=Edit&Id=<% =Id %>">Edit</a></td>
       <td align="center"><a href="projITIL-addEditDeletecompetitors.asp?deleteId=<% =Id %>">Delete</a></td>
    </tr>
     <%
      Next
      %>
