...
Dim rqActive, conObj,rqComment,rqFBdiscount
...
DIm Rs,Rs1,Rs2,Rs3,Rs4,RsPoint,strQuery3,RefID,Ref_Points,strRewPoints,RewardPoints,Points,TotalPoints
...
'Checking the VAT is null'
	...
	If rqAmount <> "" And rqFBdiscount <> "" Then
		rqTotal = (rqAmount + Int(VAT)) - Int(5)
	ElseIf rqAmount <> ""  Then
...
If rqType = "review" Then
	...
	strVAT = "SELECT MAX(VAT_Invoice) As VATInvoice FROM PROJITIL_enrolledusers"
	...
	'Updating the table'
	strQuery = "Update PROJITIL_enrolledusers Set "
...
ConnObj.Execute "UPDATE ITIL_callsreceived_new SET call_status2 = '" & rqStatus2 & "', addedby = '"& Session("UserId") &"' WHERE ID = '" & rqCourseId &"'"
 Response.Redirect("enrolments.asp?type=preview&CountryOrigin="&rqaddress_country&"&SrNo="&rqSrNo&"&SrNo2="&rqSrNo2&"")
...
ElseIf rqType = "enrollStatus" And POExpectedDate1 = "" Then
	...
	ConnObj.Execute "UPDATE PROJITIL_enrolledusers SET us_status = '" & rqEnrollStatus & "', us_status_addedby = '"& Session("UserId") &"' WHERE id = '" & rqEnrollUserId &"'"
...
ElseIf  rqType = "enrollStatus" And EnrollStatus = "P.O Received" AND POExpectedDate1 <> "" Then
	...
	ConnObj.Execute "UPDATE PROJITIL_enrolledusers SET us_status = '" & rqEnrollStatus & "', po_expected = '" & rqPOExpected & "', us_status_addedby = '"& Session("UserId") &"' WHERE id = '" & rqEnrollUserId &"'"
