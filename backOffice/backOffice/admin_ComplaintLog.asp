...
'Description :'
'COmplaint log from query/feedback Page'
'======================================================='
...
'Declare The Variables'
 ...
 Dim Sql7,Rs7,Rs, objRs, strsearch,iPageCurrent
...
strQuery="SELECT complaint_no ,customername, department, complaint, SLA, closedby,createdon,certificationId,vendorId from support_complaint where customername like '%"& rqName &"%' AND country = '"& Session("country") &"' order by complaint_no desc"
 
Else


 strQuery = "SELECT complaint_no,customername,department,complaint,SLA,closedby,createdon,certificationId,vendorId from support_complaint where country = '"& Session("country") &"' order by complaint_no desc"
  ...
  Please select the <b>Country :</b>  
		  <select name="country" >
			<option value="">--Select--</option>
             <option value="Other" <% If rqcountry = "Other" Then %> selected="selected" <% End If %>>Other</option>
			<% do until rec1.EOF 
    ...
    <tr valign="top">
      ...
      <td width="100%" valign="top"><table  width="1500px" border="1" valign="top" cellspacing="0">
       ...
       %>
		  ...
		  If  arrAllRecords(8,rowcounter)  = 1 Then %>
		  ...
		  <% End If %>
            ...
            <a href="compCommentsHistory.asp?compId=<% = arrAllRecords(0,rowcounter) %>" target="_blank">Comments History</a>
