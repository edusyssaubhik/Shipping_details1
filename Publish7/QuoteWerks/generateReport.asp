...
strQuote = "SELECT quoteId, sentDate, userId, totalAmount, tax, companyId, status FROM QW_QuoteOverview WHERE status = 'In Process'"

strQuote = strQuote & Search(rqCategory)

ElseIf rqAction = "Quote Sent" Then

strQuote = "SELECT quoteId, sentDate, userId, totalAmount, tax, companyId, status FROM QW_QuoteOverview WHERE status = 'Quote Sent'"
strQuote = strQuote & Search(rqCategory)


ElseIf rqAction = "P O Received" Then

strQuote = "SELECT quoteId, sentDate, userId, totalAmount, tax, companyId, status FROM QW_QuoteOverview WHERE status = 'P O Received'"
strQuote = strQuote & Search(rqCategory)

ElseIf rqAction = "Invoice Sent" Then

strQuote = "SELECT quoteId, sentDate, userId, totalAmount, tax, companyId, status FROM QW_QuoteOverview WHERE status = 'Invoice Sent'"
strQuote = strQuote & Search(rqCategory)

ElseIf rqAction = "Payment Received" Then

strQuote = "SELECT quoteId, sentDate, userId, totalAmount, tax, companyId, status FROM QW_QuoteOverview WHERE status = 'Payment Received'"
strQuote = strQuote & Search(rqCategory)

ElseIf rqAction = "Quote Cancelled" Then

strQuote = "SELECT quoteId, sentDate, userId, totalAmount, tax, companyId, status FROM QW_QuoteOverview WHERE status = 'Quote Cancelled'"
strQuote = strQuote & Search(rqCategory)
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="table1" width="950px">
          <tr>
           ...
           <td  align="center"><b>Quote Id</b></td>
            ...
            <% If rqAction = "Quote Sent" OR rqAction = "P O Received" OR rqAction = "Invoice Sent" Then %>            
            <td  align="center"><b>Quote</b></td>
            <% End If %>
            <% If rqAction = "P O Received" OR rqAction = "Invoice Sent"  Then %>            
            <td  align="center"><b>P.O Receipt</b></td>
            <% End If %>
            <% If rqAction = "Invoice Sent" Then %>            
		 ...
		 %>
          <tr>
           ...
           <td  align="center"><% = quoteId %></td>
            ...
            <% If quoteStatus = "Quote Sent" OR quoteStatus = "P O Received" OR quoteStatus = "Invoice Sent" Then %>
            <td><a href="/Quotewerks/ViewEditQuote.asp?action=View&id=<% = quoteId %>" target="_blank">View Quote</a></td>
            <% End If %>
           
             <% If quoteStatus = "P O Received" OR quoteStatus = "Invoice Sent" Then %>
           <td> <a href="/Quotewerks/ViewEditQuote.asp?action=View_PO&id=<% = quoteId %>" target="_blank">View P.O</a></td>
            <% End If %>
            
             <% If quoteStatus = "Invoice Sent" Then %>
            <td><a href="/Quotewerks/ViewEditQuote.asp?action=View_IS&id=<% = quoteId %>" target="_blank">View Invoice</a></td>
            <% End If %>
