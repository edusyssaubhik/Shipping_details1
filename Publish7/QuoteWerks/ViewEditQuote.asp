...
removed from overdue invoices.</b>
 ...
 <div id="quote-lowerbody" style="height:132px !important;">
   <div id="quote-left">
    ...
    <input type="hidden" name="redirecturl" value="ViewEditQuote.asp?action=View&id=<% = rqId%>" >
   ...
   strQuery1 = "select CompName from QW_Company  where compId ='"&rqcompanyId &"'"
    ...
    <tbody>
      <tr>
        ...
        <td width="15%"><a href="ViewEditQuote.asp?action=Edit&amp;id=<% = objRs22("quoteId") %>">Edit</a>/<a href="ViewEditQuote.asp?action=View&amp;id=<% = objRs22("quoteId") %>">View</a></td>
        <% If objRs22("status") = "P O Received" Then %>
        <td width="15%"><a href="ViewEditQuote.asp?action=View_PO&amp;id=<% = objRs22("quoteId") %>">View P.O</a></td>
         <% Else %>
         <td>
		<%
		Response.Write("N/A")
        ...
        <td width="15%"><a href="ViewEditQuote.asp?action=View_IS&amp;id=<% = objRs22("quoteId") %>">View Invoice sent</a></td>
         <% Else %>
         <td>
		<%
		Response.Write("N/A")
