...
<div align="left" style="margin-bottom:40px;">
  <table width="580" border="1" cellspacing="0" cellpadding="5">
	...
	strQuery = "SELECT a.quoteId,a.sentDate,a.userId,a.totalAmount,a.tax,b.CompName,a.companyId FROM QW_QuoteOverview a,QW_Company b where b.CompName = '"&rqCompName&"' AND b.compId=a.companyId"
	
	Else
	
	strQuery = "SELECT a.quoteId,a.sentDate,a.userId,a.totalAmount,a.tax,b.CompName,a.companyId FROM QW_QuoteOverview a,QW_Company b where b.CompName = '"&rqCompName&"' AND b.compId=a.companyId AND a.userId = '"&Session("QWUserName")&"'"
	...
	Else
	strQuery = "SELECT * FROM QW_QuoteOverview where sentDate >= '" & rqFromDate & "' AND sentDate <= '" & DateAdd("d", +1,CDate(rqFromDate2)) & "' AND userId = '"&Session("QWUserName")&"'"
