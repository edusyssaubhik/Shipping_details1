...
Dim objRs,strEmpDet,rqDelGID, strQuery1 ,rqItemType,  rqManufacturer,rqDeleteuserId,rqID,rqtax
Dim rqNotes,rqCustomNumber01,rqExtraMemo01,Rs1,ManufacturerPartNumber,upuser,upuser1,rqURL
 ...
 If rqType = "Add Item Details" then 
	 ...
	 'response.write("b")
 strEmpDet = "INSERT INTO QW_Category(Category,Cost,TittleDescription,ManufacturerPartNumber,supplier,VendorPartNumber,Price,List,Manufacturer,ItemType,typeofuser,Notes,CustomNumber01,ExtraMemo01,addedBy,addedDate,tax) values " 
