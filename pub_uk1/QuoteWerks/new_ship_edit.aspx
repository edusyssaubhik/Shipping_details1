        ...
        &nbsp;<table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;width:100%; height: 795px;">
            <tr>
                   ...
                   <table style="height: 294px">
                       <tr>
                           ...
                           <td>
                                   ...
                                   <asp:ListItem Value="6">Search By Contact ID</asp:ListItem>
                                       <asp:ListItem Value="3">Search by Last Name</asp:ListItem>
                               </asp:DropDownList>
                ...
                <asp:Label ID="Label1" runat="server" Text=" Company Name" Font-Size="X-Small" Visible="False"></asp:Label>
                               ...
                               <asp:Label ID="Label144" runat="server" Font-Size="X-Small"></asp:Label>

                           </td>
                           <td class="auto-style28" style="margin-left: 40px">
                           ...
                           &nbsp;&nbsp;
                               <br />
&nbsp;
                               <asp:TextBox ID="TextBox5" runat="server" AutoPostBack="True" OnTextChanged="TextBox5_TextChanged" Width="165px" Visible="False"></asp:TextBox>
                ...
                <asp:Label ID="Label5" runat="server" Text="email ID" Visible="False"></asp:Label>
                       ...
                       <tr>
                           <td>
                               ...
                               <asp:Label ID="Label42" runat="server" Text="Select Address" Visible="False"></asp:Label>
                           </td>
                           <td>

                               <asp:DropDownList ID="DropDownList19" runat="server"  OnSelectedIndexChanged="DropDownList19_SelectedIndexChanged" Width="175px" AutoPostBack="True" Visible="False" Height="16px">
                               </asp:DropDownList>
                ...
                <asp:Label ID="Label10" runat="server" Text="Ship To"></asp:Label>
                        ...
                        <tr>
                            <td class="auto-style2">
                                ...
                                <br />
                                <br />
                                <asp:Label ID="Label145" runat="server" Font-Size="X-Small" Visible="False"></asp:Label>
                ...
                <asp:Label ID="Label16" runat="server" Text="Enter  email ID" Visible="False"></asp:Label>
                       ...
                       <td class="auto-style31">
                           ...
                           <asp:DropDownList ID="DropDownList41" runat="server" AutoPostBack="True" Height="16px" Visible="False" Width="147px">
                                ...
                                <asp:Label ID="Label41" runat="server" Text="Select  Address" Visible="False"></asp:Label>
                                        </td>
                                        <td>
