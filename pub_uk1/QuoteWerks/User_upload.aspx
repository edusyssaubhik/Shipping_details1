<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_upload.aspx.cs" Inherits="Shipping_details1.QuoteWerks.User_upload" %>
...
<td width="25%" class="general-body">
  ...
  <div class="myform" id="shipMain">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <asp:Button ID="Button2" runat="server" Height="24px" OnClick="Button2_Click" Text="Add user without uploading" Width="165px" />
      <br />
