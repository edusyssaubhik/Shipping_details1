...
<body style="margin-top:0px">
  ...
  <%
    ...
    dim img_src,url
     if  action = "View" then
                 img_src="D:/new file_Quotewerks/Shipping_details1/QuoteWerks/images/quote.jpg" 
                  url="D:/new file_Quotewerks/Shipping_details1/QuoteWerks/POgeneratedReport.asp?quoteid="&rqquoteid  ' to add in I accept button
      elseif  action = "View_PO" then
                 img_src="D:/new file_Quotewerks/Shipping_details1/QuoteWerks/images/po-received.jpg"
                 
    elseif action = "View_IS" then
                 img_src="D:/new file_Quotewerks/Shipping_details1/QuoteWerks/images/invoice.jpg"
                 ' url="?"
      end if
                   ' response.Write(action)
...
strpdf = strpdf &""& rqinvoice&""

      else
strBody = strBody &""& quoteno&""
strpdf = strpdf &""& quoteno&""
...
strpdf = strpdf&"</b></td></tr><tr><td style=""text-align: right; padding-top: 6px;"" align=""right""><b>Date</b></td><td style=""text-align: right; padding-top: 6px;"" align=""right""><b>"&MonthName(Month(rqcreatedate),3) & " " & DAY(rqcreatedate) & ", "  & YEAR(rqcreatedate)&"</b></td></tr></table></td></tr></table></div><div style=""width: 866px; height: 170px; float: left; font-family: Arial, Helvetica, sans-serif; font-size: 10px; margin-left: 16px;""><table style=""width:100%;height:170px"" border=""0"" cellspacing=""6"" cellpadding=""0"" ><tr><td valign=""top""  style=""width:226px;height:18px;background-color: #efefef; border: 1px solid #bfbfbf; padding-left: 4px;"" bgcolor=""#efefef"">Sold To</td><td valign=""top""  style=""width:226px;height:18px;background-color: #efefef; border: 1px solid #bfbfbf; padding-left: 4px;"" bgcolor=""#efefef"">Ship To</td><td valign=""top"" style=""width:226px""></td><td valign=""top""  style=""width:226px;background-color: #efefef; border: 1px solid #bfbfbf; padding-left: 4px;"" bgcolor=""#efefef"">Your Account Manager</td></tr>"
	 ...
	 arr2=Split(rqshiptoAddress,"!")
	  id1=Session("QWUserName")  
       userimage="D:/new file_Quotewerks/Shipping_details1/QuoteWerks/UserImage/"&id1&"/"&id1&"_image.jpg"  
      usersign="D:/new file_Quotewerks/Shipping_details1/QuoteWerks/UserSign/"&id1&"/"&id1&"_sign.jpg"  
...
strpdf = strpdf&"<tr><td valign=""top"">"&arr1(1)&"<br />"&arr1(2)&"<br />"&arr1(3)&"<br />Phone: "&arr1(4)&"</td><td valign=""top"">"&arr2(1)&"<br />"&arr2(2)&"<br />"&arr2(3)&"<br />Phone:"&arr2(4)&"<br /></td><td valign=""top"" style=""font-size: 10px;""><b>To accept this quotation, please tickrequired line items, enter a PO number,sign &amp; date below and return.</b><br /><br /><b>Please email us if your organisation doesnot use PO numbers.</b></td><td valign=""top"" align=""left""><div style=""height: 112px""><div style=""float:left; width: 75px; height: 89px;""><img src="&userimage&" style=""height: 97px; width: 78px"" /></div><div style=""float:right; height: 93px""><b>"& rqfirstname&"&nbsp;"& rqlastname&"</b> <br /><br /> <b>"&rqofficialemailid&"</b> <br /><br /><b>"&rqphoneno&"</b><br /><br /><img src="&usersign&" style=""width: 108px; height: 30px"" /></div></div></td></tr></table><table style=""width:100%"" border=""0"" cellspacing=""0"" cellpadding=""0""><tr><td  style=""width:70px;height:18px;background-color: #efefef; border: 1px solid #bfbfbf; padding-left: 4px;"" bgcolor=""#efefef""><b>P.O. Number</b></td><td style=""width:150px"">"&rqPONumber&"</td><td style=""width:70px;height:18px;background-color: #efefef; border: 1px solid #bfbfbf; padding-left: 4px;"" bgcolor=""#efefef""><b>Terms</b></td><td>14 days before course, or 30 days from invoice, whichever is sooner</td>CR<td></td></tr></table></div><div style=""width: 866px; height: 95px; float: left; font-family: Arial, Helvetica, sans-serif; font-size: 10px; margin-left: 16px; margin-bottom: 20px;""><table   border=""0"" cellspacing=""0"" cellpadding=""4"" style=""width:100%;border-collapse:collapse;""><tr><td style=""height:20pt""></td><td style=""height:20pt""></td><td style=""height:20pt""></td><td style=""height:20pt""></td><td style=""height:20pt""></td><td style=""height:20pt""></td><td style=""height:20pt""></td><td style=""height:20pt""></td><td style=""height:20pt""></td><td style=""height:20pt""></td><td style=""height:20pt""></td><td style=""height:20pt""></td></tr><tr><td valign=""middle"" valign=""top"" width=""24pt""></td><td valign=""middle"" valign=""top""  align=""center"" style=""width:33px;border:1px solid #bfbfbf;""><b>Line</b></td><td valign=""middle"" valign=""top""  align=""center"" style=""width:38pt;border: 1px solid #bfbfbf;""><b>Qty</b></td><td valign=""middle"" valign=""top""  align=""center"" style=""width:70px;border: 1px solid #bfbfbf;""><b>Course Code</b></td><td valign=""middle"" valign=""top""  align=""center"" style=""width:335px;border: 1px solid #bfbfbf;""><b>Description</b></td><td valign=""middle"" valign=""top""  align=""center"" style=""width:30px;border: 1px solid #bfbfbf;""><b>Days</b></td><td valign=""middle"" valign=""top""  align=""center"" style=""width:41px;border: 1px solid #bfbfbf;""><b>RRP "&currency1&"</b></td><td valign=""middle"" valign=""top""  align=""center"" style=""width:41px;border: 1px solid #bfbfbf;""><b>Discount</b></td><td valign=""middle"" valign=""top""  align=""center"" style=""width:41px;border: 1px solid #bfbfbf;""><b>Unit "&currency1&"</b></td><td valign=""middle"" valign=""top""  align=""center"" style=""width:49px;border: 1px solid #bfbfbf;""><b>Total</b></td></tr>"
	  ...
	  If Not Rs7.EOF Then  
       cus_no=Rs7("a") 
		...
		strBody = strBody &"<tr><td valign=""top"" width=""24"" style=""border: 1px solid #bfbfbf;""></td><td valign=""top"" width=""33"" align=""center"">"&SrNo&"</td><td valign=""top"" width=""38"" align=""center"">"&arrAllUsers(7,rowcounter)&"</td><td valign=""top"" width=""63"" align=""center"">"&arrAllUsers(4,rowcounter)&"</td><td valign=""top"" width=""344"" align=""center"">"&arrAllUsers(3,rowcounter)&"</td><td valign=""top"" width=""30"" align=""center"">"&cus_no&"</td><td valign=""top"" width=""41"" align=""center"">"&currency1&""&rrp1&"</td><td valign=""top"" width=""49"" align=""center"">"&currency1&""&dis1&"</td><td valign=""top"" width=""41"" align=""center"">"&currency1&""&unit1&"</td><td valign=""top"" width=""49"" align=""center"">"&currency1&""&arrAllUsers(11,rowcounter)&"</td></tr>"
      		...
      		strpdf = strpdf &"<tr><td valign=""top""  style=""width:24pt;border: 1px solid #bfbfbf;""></td><td valign=""top"" style=""width:33pt"" align=""center"">"&SrNo&"</td><td valign=""top"" style=""width:38pt""  align=""center"">"&arrAllUsers(7,rowcounter)&"</td><td valign=""top"" style=""width:63pt"" align=""center"">"&arrAllUsers(4,rowcounter)&"</td><td valign=""top"" style=""width:344pt"" align=""center"">"&arrAllUsers(3,rowcounter)&"</td><td valign=""top"" style=""width:30pt"" align=""center"">"&cus_no&"</td><td valign=""top"" style=""width:41pt"" align=""center"">"&currency1&""&rrp1&"</td><td valign=""top"" style=""width:49pt"" align=""center"">"&currency1&""&dis1&"</td><td valign=""top"" style=""width:41pt"" align=""center"">"&currency1&""&unit1&"</td><td valign=""top"" style=""width:49px"" align=""center"">"&currency1&""&arrAllUsers(11,rowcounter)&"</td></tr>"
...
strpdf = strpdf &"<div style=""width: 866px; height: 160px; float: left; font-family: Arial, Helvetica, sans-serif; font-size: 10px; margin-left: 16px;""><div style=""width: 484px; float: left; text-align:left;"">I am authorised to place this order:<table style=""width:192px"" border=""0"" cellspacing=""0"" cellpadding=""0""><tr><td style=""width:36pt;height:22pt"">Signature:</td><td  style=""height:22pt;border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #333;""></td></tr><tr><td style=""width:36;height:22"">Date:</td><td  style=""height:22px;border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #333;""></td></tr><tr><td style=""width:36px;height:22px"">Name:</td><td  style=""height:22px;border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #333;""></td></tr><tr><td style=""width:36px;height:22px"">Position:</td><td style=""height:22px;border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #333;""></td></tr></table></div><div style=""width: 187px; float: left;""><div style=""background-color: #efefef; border: 1px solid #bfbfbf; padding: 10px 0px 10px 8px;""><b>Please note: discounts are appliedassuming prompt payment and will beremoved from overdue invoices.</b></div></div><div style=""width: 162px; float: right;""><div style=""width: 155px; height: 68px; padding: 4px; border: 1px solid #ccc;"">"
...
strpdf = strpdf &"<table style=""width:100%"" border=""0"" cellspacing=""0"" cellpadding=""0""><tr><td><b>RRP Total</b></td><td align=""right"">"&currency1&""&rqtotalActualPrice&"</td></tr><tr><td><b>Discount Total</b></td><td align=""right"">"&currency1&""&rqtotalDiscount&"</td></tr><tr><td><b>SubTotal</b></td><td align=""right"">"&currency1&""&rqtotalsellingPrice&"</td></tr><tr><td><b>VAT</b></td><td align=""right"">"&currency1&""&rqtax&"</td></tr><tr><td><b>Shipping Charges</b></td><td align=""right"">"&currency1&""&add&"</td></tr></table></div><div style=""background-color: #efefef; margin-top: 4px; border: 1px solid #bfbfbf; padding: 3px; height: 20px; width: 157px;""><table  border=""0"" cellspacing=""0"" cellpadding=""0"" style=""width=100%""><tr><td>Total</td><td style=""text-align:right;"">"&currency1&""&rqtotalAmount&"</td></tr></table></div></div></div>"
...
strpdf = strpdf &"<div style=""width: 866px; height: 52px; float: left; font-family: Arial, Helvetica, sans-serif; font-size: 10px; margin-left: 16px; border-top-color: #999; border-top-style: solid; border-top-width: 1px; text-align: center; color: #666; padding-top: 10px;"" align=""center""> We accept all major credit and debit cards for payment. Head office: N1 CBTC, Euxton Lane, Chorley, Lans PR7 6TE Post Sales line: 01772 623467 Email: sales@datrixtraining.com Sales line: 0800 781 0626Our terms of business can be viewed at:<a href=""#d41d8cd98f00b204e9800998ecf8427e"">http://www.datrixtraining.com/about/terms/</a> Datrix Training Limited - Company number 4344412</div></div></div></td></tr></table>"
...
strpdf = strpdf &"<table><tr><td><input type=""hidden""  name=""officialemailid"" value="&officialemailid&"><input type=""hidden""  name=""Userid"" value="&Session("QWUserName")&"><input type=""hidden"" name=""quoteId"" value="& quoteid &"></td></tr></table>"

strBody = strBody & "<table><tr><td align=""left""><br><font face=""Arial"" size=2>Best Regards,</font></td></tr>"

strpdf = strpdf & "<table><tr><td align=""left""><br><font face=""Arial"" size=2>Best Regards,</font></td></tr>"
...
strpdf = strpdf & "<tr><td align=""left""><font face=""Arial"" size=2><br>"& rqfirstname&"&nbsp;"& rqlastname&" <br />"&rqofficialemailid&" <br />"&rqphoneno&"<br>Datrix Training </td></font></td></tr></table>"

if rqinvoice<>"" then
strBody =strBody &"</center>"
strpdf =strpdf &"</center>"
...
strBody = strBody &"<table><tr><td>Please click <a href="&urls&"><input type=""button"" value=""I Accept""/></a> to place a purchase order.</td></tr></table><table><tr><td>If the ""I Accept"" button is not working, please reply to this email with ""I Agree""  in the subject line.</td></tr><tr><td><input type=""hidden""  name=""officialemailid"" value="&rqofficialemailid&"><input type=""hidden""  name=""Userid"" value="&Session("QWUserName")&"><input type=""hidden"" name=""quoteId"" value="& quoteid &"></td></tr></table></center>"
  ...
  'if session("body")="" then
     session("body")=strBody
      'end if
  session("strpdf")=strpdf
       
      response.Write(session("strpdf"))
      dim fs,fname
set fs=Server.CreateObject("Scripting.FileSystemObject")
set fname=fs.CreateTextFile("D:/new file_Quotewerks/Shipping_details1/QuoteWerks/xyz_quote.html",true)
fname.Write(strpdf)
fname.Close
set fname=nothing
set fs=nothing
