...
'send the mail
         strBody=strBody&"Hi<br><br>Please find below the feedback from the MyITstudy CompTIA certification - A+ App<br><br><br>"
...
objCDOMail.Subject = "Feedback from CompTIA certification - A+ App"
