   ...
   strQuery1 = "select CompName from QW_Company  where compId ='"&rqcompanyId &"'"
    ...
    <tbody>
      <tr>
        ...
        <td width="15%"><a href="ViewEditQuote.asp?action=Edit&amp;id=<% = objRs22("quoteId") %>">Edit</a></td>
        <td width="15%"><a href="ViewEditQuote.asp?action=View&amp;id=<% = objRs22("quoteId") %>">View</a></td>
