...
<!--#include virtual="Quotewerks/includes/displayFormat.asp"-->
<%
...
'===============================================================================================================================================================================-->
    ...
    <tr id="htMap">
      <td  height="25px" class="auto-style2" > <% If Session("typeofuser") <> "CSR" Then %><a href="datrixClass.asp?type=add&certificate=<% = rqCertificate %>">Add Class </a> |  <% End If %> <a href="datrixClass.asp?Course=PastCourses&certificate=<% = rqCertificate %>">Past Classes</a> | <a href="datrixClass.asp?Course=FutureCourses&certificate=<% = rqCertificate %>">Future Classes</a> | <a href="datrixClass.asp?type=selectcourse"><span style="color:#FF3300">Change certification type</span></a></td>
    </tr>
...
'===============================================================================================================================================================================-->
    ...
    <tr >
      <td align="left" height="200px" class="auto-style2">
...
<% End If %>
 ...
 <tr>
      <td>Venue:</td>
       ...
       <td><input type="text" name="enddate1" id="checkOut_date1" /></td>     
       &nbsp;</td>
          </td>
       ...
       <tr>
          ...
          <td class="auto-style1">End Date</td>
       <td><input type="text" name="enddate2" id="checkOut_date2" disabled /></td>     
        ...
        <tr>
         <td  class="zpCalSubheader"> Date Begin: </td>
          ...
          <td class="auto-style1">End Date</td>
       <td><input type="text" name="enddate3" id="checkOut_date3" disabled /></td>     
       </tr>
        <tr>
        <td  class="zpCalSubheader"> Date Begin: </td>
          ...
          <td class="auto-style1">End Date</td>
       <td><input type="text" name="enddate4" id="checkOut_date4" disabled /></td>     
        </tr>
        <tr>
        <td  class="zpCalSubheader"> Date Begin: </td>
          <td><input name="startdate4"  id="checkIn_date5" type="text" onchange="findValue1(5)">
            <input value=" ... " id="button8k" class="buttonc" type="reset">
          </td>
          <td class="auto-style1">End Date</td>
       <td><input type="text" name="enddate5" id="checkOut_date5" disabled /></td>     
        </tr>
       ...
       <tr  id = "datrixCourse2" style="display:table-row;">
          ...
          <td><input type="text" name="priceWithOutTax" value="0" size="20" maxlength="15" onchange="calculate()">
            <br>
            &nbsp;&nbsp;&nbsp;<font face="Arial" color="red" size="2">(Ex : 650 )</font></td>

      
          <td class="auto-style1" >Tax:</td>
...
<tr>
          ...
          <td class="auto-style1" >Applicable Days:</td>
        ...
        <tr>
          ...
          <td class="auto-style1">Price After EarlyBird Discount(With Tax):</td>
         ...
         <tr>
          ...
          <td class="auto-style1" >BackUp Instructor:</td>
          <td>&nbsp;&nbsp;
        ...
        <tr>
          ...
          <td class="auto-style1">Hotel Phone Number: </td>
          ...
          <tr>
              <td class="auto-style2">Hotel URL: </td>
          ...
          <tr>
              <td class="auto-style2">Hotel Address: </td>
        ...
        <% 'RsRef.Movenext
          ...
          <tr>
              <td colspan="4" align="center"><input type="submit" name="addcourse" value="Add Course" onclick="return checkUrl(this.hotelurl);" class="buttonc"/>
              </td>
            </tr>
