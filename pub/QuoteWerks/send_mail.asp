...
<body style="margin-top:0px">
  ...
  <%
    ...
    dim img_src,url
     if  action = "View" then
                 img_src="/QuoteWerks/images/quote.jpg" 
                  url="/Quotewerks/POgeneratedReport.asp?quoteid="&rqquoteid  ' to add in I accept button
      elseif  action = "View_PO" then
                 img_src="/QuoteWerks/images/po-received.jpg"
                 
    elseif action = "View_IS" then
                 img_src="/QuoteWerks/images/invoice.jpg"
                 ' url="?"
      end if
                   ' response.Write(action)
