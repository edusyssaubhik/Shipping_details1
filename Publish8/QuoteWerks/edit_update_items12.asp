...
'Session("quote_no")
 ...
 strQuery = "INSERT INTO QW_QuoteDetails(quoteId,versionNo,itemName,itemCode,cost,price,quantity,actualPrice,discount,discountAmount,sellingPrice,FinalPrice,tax,shipping,totalAmount,courseid,addedBy,addedDate,status,quoteno) values  ('"& ses_new &"',"&version_no&","&items&",'"&Session("QWUserName")&"','"& Now() &"','In Process','"&qono&"')"
    response.Write(strQuery)
ConnObj.Execute strQuery
Next
'Session("quote")=""
 
  sql1="update QW_QuoteOverview set countryId='"&Session("country")&"',totalAmount='"& total &"',tax='"& tax &"' ,totalDiscount ='"& dis &"' ,totalActualPrice='"& act &"',totalsellingPrice='"& sell &"' where quoteId='"& ses_new &"'"
