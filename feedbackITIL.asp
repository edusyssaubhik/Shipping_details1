...
'send the mail
         strBody=strBody&"Hi<br><br>Please find below the feedback from the MyITstudy ITIL certification App<br><br><br>"
...
objCDOMail.Subject = "Feedback from ITIL certification App"
