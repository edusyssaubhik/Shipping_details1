...
'	   Response.Write(userName)
 ...
 strQuery1 = "SELECT userid FROM users where userid = '" & EmailID(0) & "'"
	 ...
	 'response.write("b")
 strEmpDet = "INSERT INTO users(firstname,lastname,userid,password,officialemailid,personalemailid,phoneno,Designation,typeofuser,addedBy,addedDate) values " 
...
'objmail.From = "edusyssavita@gmail.com"

objmail.To =  ""&rqofficialemailid&""    
objmail.cc = "edusyssavita@gmail.com,edusysayan@gmail.com"
objmail.Importance = 2
objmail.Subject = "Login Details - VMQuotes"
