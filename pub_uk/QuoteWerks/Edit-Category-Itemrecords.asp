 ...
 */   
	...
	//	var sell='sell_'+y;
		...
		querystring[i-1]="'"+item1+"','"+code1+"','"+cost1+"','"+price1+"',"+qty+",'"+ac_p+"','"+dis+"','"+di+"','"+sel+"','"+fin+"','"+tax_x+"','"+ship+"','"+total_price+"',"+0+",'"+margin +"'";
...
SQL="SELECT itemName a ,itemCode b,cost c,price d,quantity e,actualPrice f,discount g ,discountAmount h,sellingPrice i,FinalPrice j,tax k,shipping l,margin m FROM QW_QuoteDetails where quoteId='"&Session("qid_edit")&"' and itemCode  in ("& common_item &")"
rs.open SQL, ConnObj
While Not rs.EOF
i=i+1 
j=j+1
